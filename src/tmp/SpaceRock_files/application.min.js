...
!(function(a) {
  ...
  function a(c, d) {
    ...
    var e = d.value;
    "string" == typeof e && (e = new bg(e, d.mode)), (this.doc = e);
    ...
    hb(this, function() {
      (g.curOp.forceUpdate = !0),
        Cd(g, e),
        (d.autofocus && !hf) || xe() == f.input
          ? setTimeout(pe(Yb, g), 20)
          : Zb(g);
      for (var a in Gf) Gf.hasOwnProperty(a) && Gf[a](g, d[a], Hf);
      u(g);
      for (var b = 0; b < Lf.length; ++b) Lf[b](g);
    });
  }
  function b(a, b) {
    var c = this,
    ...
    $e ? (d.style.width = "1000px") : d.setAttribute("wrap", "off"),
      ...
      (c.scrollbarH = te(
        "div",
        [te("div", null, null, "height: 100%; min-height: 1px")],
        "CodeMirror-hscrollbar"
      )),
      (c.scrollbarV = te(
        "div",
        [te("div", null, null, "min-width: 1px")],
      ...
      (c.mover = te(
        "div",
        [te("div", [c.lineSpace], "CodeMirror-lines")],
        null,
        "position: relative"
      )),
      ...
      (c.heightForcer = te(
        ...
        null,
        null,
        "position: absolute; height: " + lg + "px; width: 1px;"
      )),
  ...
  function e(a) {
    a.options.lineWrapping
      ? (Ae(a.display.wrapper, "CodeMirror-wrap"),
        (a.display.sizer.style.minWidth = ""))
      : (ze(a.display.wrapper, "CodeMirror-wrap"), n(a)),
      g(a),
      nb(a),
      Na(a),
      setTimeout(function() {
  ...
  function p(a) {
    return (
      a.display.scroller.clientHeight - a.display.wrapper.clientHeight < lg - 3
    );
  }
  function q(a) {
  ...
  function r(a, b) {
    ...
    if (
      ...
      if (0 === d) {
        ...
        hg(c.scrollbarV, "mousedown", i), hg(c.scrollbarH, "mousedown", i);
      }
  ...
  function s(a, b, c) {
    ...
    if (c && c.ensure) {
      var h = c.ensure.from.line,
        i = c.ensure.to.line;
      if (f > h)
        return { from: h, to: Id(b, Jd(Dd(b, h)) + a.wrapper.clientHeight) };
      if (Math.min(i, b.lastLine()) >= g)
        return { from: Id(b, Jd(Dd(b, i)) - a.wrapper.clientHeight), to: i };
    }
  ...
  function t(a) {
    ...
    if (b.alignWidgets || (b.gutters.firstChild && a.options.fixedGutter)) {
      for (
        var d = w(b) - b.scroller.scrollLeft + a.doc.scrollLeft,
  ...
  function y(a, b) {
    ...
    return (
      ...
      ue(c.cursorDiv),
      ue(c.selectionDiv),
      h && ((c.lastSizeC = b.wrapperHeight), va(a, 400)),
      (c.updateLineNumbers = null),
      !0
    );
  }
  function z(a, b) {
    ...
    be(a, "update", a),
      (a.display.viewFrom != b.oldViewFrom ||
        ...
        be(a, "viewportChange", a, a.display.viewFrom, a.display.viewTo);
  }
  function A(a, b) {
    var c = new x(a, b);
    if (y(a, c)) {
  ...
  function B(a, b) {
    (a.display.sizer.style.minHeight = a.display.heightForcer.style.top =
      ...
      (a.display.gutters.style.height =
        Math.max(b.docHeight, b.clientHeight - lg) + "px");
  }
  function C(a, b) {
  ...
  function D(a) {
    for (
      var b = a.display, c = b.lineDiv.offsetTop, d = 0;
      d < b.view.length;
      d++
    ) {
      var e,
      ...
      if (!f.hidden) {
        ...
        if (
          (2 > e && (e = Ya(b)),
          (i > 0.001 || -0.001 > i) && (Gd(f.line, e), E(f.line), f.rest))
        )
          for (var j = 0; j < f.rest.length; j++) E(f.rest[j]);
      }
    }
  }
  function E(a) {
  ...
  function G(a, b, c) {
    function d(b) {
      var c = b.nextSibling;
      return (
        $e && jf && a.display.currentWheelTarget == b
    ...
    for (
      ...
      if (l.hidden);
        ...
        l.changes && (le(l.changes, "gutter") > -1 && (m = !1), H(a, l, j, c)),
          m &&
            (ue(l.lineNumber),
  ...
  function I(a) {
    return (
      a.node == a.text &&
        ((a.node = te("div", null, null, "position: relative")),
  ...
  function L(a, b) {
    ...
    b.text == b.node && (b.node = d.pre),
      ...
      d.bgClass != b.bgClass || d.textClass != b.textClass
        ? ((b.bgClass = d.bgClass), (b.textClass = d.textClass), M(b))
        : c && (b.text.className = c);
  }
  function M(a) {
    J(a),
      a.line.wrapClass
        ? (I(a).className = a.line.wrapClass)
  ...
  function Q(a, b) {
    if ((R(a.line, a, b, !0), a.rest))
      for (var c = 0; c < a.rest.length; c++) R(a.rest[c], a, b, !1);
  }
  function R(a, b, c, d) {
    if (a.widgets)
  ...
  function Y(a, b) {
    ...
    for (var d = 1; d < a.length; d++) {
      ...
      if (rf(f.to(), e.from()) >= 0) {
        ...
        b >= d && --b, a.splice(--d, 2, new X(i ? h : g, i ? g : h));
      }
    }
    return new W(a, b);
  }
  ...
  function _(a, b) {
    if (b.line < a.first) return qf(a.first, 0);
    var c = a.first + a.size - 1;
    return b.line > c
      ? qf(c, Dd(a, c).text.length)
      : aa(b, Dd(a, b.line).text.length);
  }
  function aa(a, b) {
    var c = a.ch;
  ...
  function ca(a, b) {
    for (var c = [], d = 0; d < b.length; d++) c[d] = _(a, b[d]);
    return c;
  }
  function da(a, b, c, d) {
    if ((a.cm && a.cm.display.shift) || a.extend) {
      ...
      if (d) {
        var f = rf(c, e) < 0;
        f != rf(d, e) < 0 ? ((e = c), (c = d)) : f != rf(c, d) < 0 && (c = d);
      }
      return new X(e, c);
    }
    return new X(d || c, c);
  ...
  function ga(a, b, c, d) {
    ...
    (e[b] = c), ka(a, Y(e, a.sel.primIndex), d);
  }
  function ha(a, b, c, d) {
    ka(a, Z(b, c), d);
  }
  function ia(a, b) {
    ...
    return (
      jg(a, "beforeSelectionChange", a, c),
  ...
  function ka(a, b, c) {
    la(a, b, c), Rd(a, a.sel, a.cm ? a.cm.curOp.id : NaN, c);
  }
  function la(a, b, c) {
    (fe(a, "beforeSelectionChange") ||
      (a.cm && fe(a.cm, "beforeSelectionChange"))) &&
      (b = ia(a, b));
    var d =
      (c && c.bias) ||
      (rf(b.primary().head, a.sel.primary().head) < 0 ? -1 : 1);
    ma(a, oa(a, b, d, !0)), (c && c.scroll === !1) || !a.cm || rc(a.cm);
  }
  function ma(a, b) {
    b.equals(a.sel) ||
      ((a.sel = b),
      a.cm &&
        ((a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0), ee(a.cm)),
  ...
  function oa(a, b, c, d) {
    for (var e, f = 0; f < b.ranges.length; f++) {
      ...
      (e || h != g.anchor || i != g.head) &&
        (e || (e = b.ranges.slice(0, f)), (e[f] = new X(h, i)));
    }
      ...
      if (h.markedSpans)
        for (var i = 0; i < h.markedSpans.length; ++i) {
          ...
          if (
            ...
            if (d && (jg(k, "beforeCursorEnter"), k.explicitlyCleared)) {
              if (h.markedSpans) {
                --i;
                continue;
              }
            ...
            if (
              ...
              ((l.ch += g),
              l.ch < 0
                ? (l = l.line > a.first ? _(a, qf(l.line - 1)) : null)
                : l.ch > h.text.length &&
                  (l =
                    l.line < a.first + a.size - 1 ? qf(l.line + 1, 0) : null),
              !l)
            ) {
              if (e)
                return d
                  ? ((a.cantEdit = !0), qf(a.first, 0))
                  : pa(a, b, c, !0);
              (e = !0), (l = b), (g = -g);
            }
            f = l;
  ...
  function sa(a, b, c) {
    ...
    if (
      ...
      var f = c.appendChild(
        te("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor")
      );
      (f.style.display = ""),
  ...
  function ta(a, b, c) {
    ...
    function e(b, c, e) {
      ...
      var h,
        ...
        m = l.text.length;
      return (
        Je(Kd(l), c || 0, null == e ? m : e, function(a, b, g) {
          var l,
            n,
            o,
            p = f(a, "left");
          ...
          null == c && 0 == a && (n = j),
            l.top - p.top > 3 &&
              (d(n, p.top, null, p.bottom),
              (n = j),
              p.bottom < l.top && d(n, p.bottom, null, l.top)),
            null == e && b == m && (o = k),
            (!h || p.top < h.top || (p.top == h.top && p.left < h.left)) &&
              (h = p),
            (!i ||
              l.bottom > i.bottom ||
              (l.bottom == i.bottom && l.right > i.right)) &&
              (i = l),
            j + 1 > n && (n = j),
    ...
    if (l.line == m.line) e(l.line, l.ch, m.ch);
      ...
      p &&
        (q.top < r.top - 2
          ? (d(q.right, q.top, null, q.bottom), d(j, r.top, r.left, r.bottom))
          : d(q.right, q.top, r.left - q.right, q.bottom)),
  ...
  function va(a, b) {
    a.doc.mode.startState &&
      ...
      a.state.highlight.set(b, pe(wa, a));
  }
  function wa(a) {
    var b = a.doc;
    if (
        ...
        function(f) {
          if (b.frontier >= a.display.viewFrom) {
            ...
            for (
              ...
              k = g[l] != f.styles[l];
            k && e.push(b.frontier), (f.stateAfter = Nf(b.mode, d));
          } else
            od(a, f.text, d),
              (f.stateAfter = b.frontier % 5 == 0 ? Nf(b.mode, d) : null);
          return (
            ++b.frontier,
            +new Date() > c ? (va(a, a.options.workDelay), !0) : void 0
          );
        }
      ),
        e.length &&
  ...
  function Ea(a, b) {
    ...
    return (d.text = e.pre), ve(a.display.lineMeasure, e.pre), d;
  }
  function Fa(a, b, c, d) {
  ...
  function Ia(a, b, c, d, e) {
    ...
    var f,
      g = c + (d || "");
    return (
      b.cache.hasOwnProperty(g)
        ? (f = b.cache[g])
        : (b.rect || (b.rect = b.view.text.getBoundingClientRect()),
          b.hasHeights || (Ca(a, b.view, b.rect), (b.hasHeights = !0)),
          (f = Ja(a, b, c, d)),
          f.bogus || (b.cache[g] = f)),
      {
        left: f.left,
  ...
  function Ja(a, b, c, d) {
    for (var e, f, g, h, i = b.map, j = 0; j < i.length; j += 3) {
      ...
      if (
        (k > c
          ...
          : l > c
          ? ((f = c - k), (g = f + 1))
          : (j == i.length - 3 || (c == l && i[j + 3] > c)) &&
            ((g = l - k), (f = g - 1), c >= l && (h = "right")),
        null != f)
      ) {
        if (
          ((e = i[j + 2]),
        ...
        if ("right" == d && f == l - k)
          for (
            ;
            j < i.length - 3 && i[j + 3] == i[j + 4] && !i[j + 5].insertLeft;
    ...
    var m;
    if (3 == e.nodeType) {
      for (; f && se(b.line.text.charAt(k + f)); ) --f;
      for (; l > k + g && se(b.line.text.charAt(k + g)); ) ++g;
      ...
      } else m = tg(e, f, g).getBoundingClientRect() || vf;
    } else {
      f > 0 && (h = d = "right");
      var n;
      m =
        a.options.lineWrapping && (n = e.getClientRects()).length > 1
          ? n["right" == d ? n.length - 1 : 0]
    ...
    for (
      var p = m.top - b.rect.top,
        q = m.bottom - b.rect.top,
        r = (p + q) / 2,
        s = b.view.measure.heights,
        j = 0;
      j < s.length - 1 && !(r < s[j]);
      j++
    );
    ...
    return (
      m.left || m.right || (v.bogus = !0),
      a.options.singleCursorHeightPerLine || ((v.rtop = p), (v.rbottom = q)),
      v
    );
  }
  function Ka(a, b) {
  ...
  function Ma(a) {
    (a.display.externalMeasure = null), ue(a.display.lineMeasure);
  ...
  function Qa(a, b, c, d) {
    ...
    var g = Jd(b);
    if (
      ("local" == d ? (g += za(a.display)) : (g -= a.display.viewOffset),
      "page" == d || "window" == d)
    ) {
  ...
  function Sa(a, b, c, d, e) {
    return d || (d = Dd(a.doc, b.line)), Qa(a, d, Fa(a, d, b.ch, e), c);
  }
  function Ta(a, b, c, d, e, f) {
    ...
    function h(a, b) {
      var c = i[b],
        d = c.level % 2;
      return (
        a == Ke(c) && b && c.level < i[b - 1].level
          ? ((c = i[--b]), (a = Le(c) - (c.level % 2 ? 0 : 1)), (d = !0))
          : a == Le(c) &&
            b < i.length - 1 &&
            c.level < i[b + 1].level &&
            ((c = i[++b]), (a = Ke(c) - (c.level % 2)), (d = !1)),
        d && a == c.to && a > c.from ? g(a - 1) : g(a, d)
      );
    }
    (d = d || Dd(a.doc, b.line)), e || (e = Ha(a, d));
    var i = Kd(d),
      j = b.ch;
    if (!i) return g(j);
    var k = Re(i, j),
      l = h(j, k);
    return null != Hg && (l.other = h(j, Hg)), l;
  }
  function Ua(a, b) {
    var c = 0,
      b = _(a.doc, b);
  ...
  function Wa(a, b, c) {
    ...
    var e = Id(d, c),
      f = d.first + d.size - 1;
    if (e > f) return Va(d.first + d.size - 1, Dd(d, f).text.length, !0, 1);
    0 > b && (b = 0);
    for (var g = Dd(d, e); ; ) {
      var h = Xa(a, g, e, b, c),
        i = Xc(g),
  ...
  function Ya(a) {
    ...
    if (null == sf) {
      sf = te("pre");
      for (var b = 0; 49 > b; ++b)
        sf.appendChild(document.createTextNode("x")), sf.appendChild(te("br"));
      sf.appendChild(document.createTextNode("x"));
    }
    ve(a.measure, sf);
    var c = sf.offsetHeight / 50;
    return c > 3 && (a.cachedTextHeight = c), ue(a.measure), c || 1;
  }
  function Za(a) {
  ...
  function $a(a) {
    (a.curOp = {
      ...
      wf
        ? wf.ops.push(a.curOp)
        : (a.curOp.ownsGroup = wf = { ops: [a.curOp], delayedCallbacks: [] });
  }
  function _a(a) {
  ...
  function eb(a) {
    ...
    a.updatedDisplay && D(b),
      c.maxLineChanged &&
        ...
        ((a.adjustWidthTo = Fa(b, c.maxLine, c.maxLine.text.length).left),
        (a.maxScrollLeft = Math.max(
          0,
          c.sizer.offsetLeft + a.adjustWidthTo + lg - c.scroller.clientWidth
        ))),
      (a.barMeasure = q(b)),
  ...
  function fb(a) {
    ...
    null != a.adjustWidthTo &&
      ...
      a.maxScrollLeft < b.doc.scrollLeft &&
        Ob(b, Math.min(b.display.scroller.scrollLeft, a.maxScrollLeft), !0)),
  ...
  function gb(a) {
    ...
    if (a.scrollToPos) {
      var g = nc(
        b,
        _(d, a.scrollToPos.from),
        _(d, a.scrollToPos.to),
    ...
    if (h)
      for (var j = 0; j < h.length; ++j) h[j].lines.length || jg(h[j], "hide");
    if (i)
    ...
    c.wrapper.offsetHeight && (d.scrollTop = b.display.scroller.scrollTop),
      a.updatedDisplay &&
        $e &&
        (b.options.lineWrapping && C(b, a.barMeasure),
  ...
  function rb(a, b, c, d) {
    var e,
      f = qb(a, b),
      g = a.display.view;
    if (!pf || c == a.doc.first + a.doc.size) return { index: f, lineN: c };
  ...
  function sb(a, b, c) {
    ...
    0 == e.length || b >= d.viewTo || c <= d.viewFrom
      ? ((d.view = mb(a, b, c)), (d.viewFrom = b))
      : (d.viewFrom > b
          ? (d.view = mb(a, b, d.viewFrom).concat(d.view))
          : d.viewFrom < b && (d.view = d.view.slice(qb(a, b))),
        (d.viewFrom = b),
        d.viewTo < c
          ? (d.view = d.view.concat(mb(a, d.viewTo, c)))
          : d.viewTo > c && (d.view = d.view.slice(0, qb(a, c)))),
      (d.viewTo = c);
  }
  function tb(a) {
  ...
  function wb(a) {
    ...
    if (
      (Ye && Ze >= 9 && a.display.inputHasSelection === e) ||
      (jf && /[\uf700-\uf7ff]/.test(e))
    )
      return xb(a), !1;
    var f = !a.curOp;
    f && $a(a),
      (a.display.shift = !1),
      8203 != e.charCodeAt(0) ||
        d.sel != a.display.selForContextMenu ||
        c ||
        (c = "​");
    for (
      var g = 0, h = Math.min(c.length, e.length);
      h > g && c.charCodeAt(g) == e.charCodeAt(g);
    ...
    var i = e.slice(g),
      ...
      k = null;
    a.state.pasteIncoming &&
      d.sel.ranges.length > 1 &&
      (yf && yf.join("\n") == i
        ? (k = d.sel.ranges.length % yf.length == 0 && me(yf, Cg))
        : j.length == d.sel.ranges.length &&
          (k = me(j, function(a) {
            return [a];
          })));
    for (var l = d.sel.ranges.length - 1; l >= 0; l--) {
      var m = d.sel.ranges[l],
        ...
        o = m.to();
      g < c.length
        ? (n = qf(n.line, n.ch - (c.length - g)))
        : a.state.overwrite &&
          m.empty() &&
          !a.state.pasteIncoming &&
          (o = qf(
            o.line,
            Math.min(Dd(d, o.line).text.length, o.ch + ke(j).length)
          ));
      ...
      if (
        ...
        i &&
          ...
          m.head.ch < 100 &&
          (!l || d.sel.ranges[l - 1].head.line != m.head.line))
      ) {
        ...
        if (r.electricChars) {
          ...
          var t = Ef(q);
          r.electricInput.test(Dd(d, t.line).text.slice(0, t.ch)) &&
            tc(a, m.head.line, "smart");
        }
      }
    }
  ...
  function xb(a, b) {
    ...
    } else b || ((a.display.prevInput = a.display.input.value = ""), Ye && Ze >= 9 && (a.display.inputHasSelection = null));
    a.display.inaccurateSelection = c;
  }
  function yb(a) {
    "nocursor" == a.options.readOnly ||
      (hf && xe() == a.display.input) ||
      a.display.input.focus();
  }
  function zb(a) {
    a.state.focused || (yb(a), Yb(a));
  }
  function Ab(a) {
  ...
  function Bb(a) {
      ...
      if (a.somethingSelected())
        ...
        for (var c = [], d = [], f = 0; f < a.doc.sel.ranges.length; f++) {
          var g = a.doc.sel.ranges[f].head.line,
            h = { anchor: qf(g, 0), head: qf(g + 1, 0) };
          d.push(h), c.push(a.getRange(h.anchor, h.head));
        }
        "cut" == b.type
          ? a.setSelections(d, null, ng)
          : ((e.prevInput = ""), (e.input.value = c.join("\n")), sg(e.input)),
          (yf = c);
      }
    ...
    hg(e.scroller, "mousedown", ib(a, Fb)),
      ...
      nf ||
        hg(e.scroller, "contextmenu", function(b) {
          $b(a, b);
        }),
      hg(e.scroller, "scroll", function() {
        e.scroller.clientHeight &&
          (Nb(a, e.scroller.scrollTop),
      ...
      a.options.dragDrop &&
        (hg(e.scroller, "dragstart", function(b) {
          Mb(a, b);
        }),
      ...
      hg(e.input, "copy", d),
      df &&
        hg(e.sizer, "mouseup", function() {
          xe() == e.input && e.input.blur(), yb(a);
        });
  }
  function Cb(a) {
    var b = a.display;
  ...
  function Eb(a, b, c, d) {
    ...
    if (d && 1 == k.xRel && (j = Dd(a.doc, k.line).text).length == k.ch) {
      ...
      k = qf(
        k.line,
        Math.max(0, Math.round((g - Ba(a.display).left) / Za(a.display)) - l)
      );
    }
    return k;
  }
  ...
  function Gb(a, b, c) {
    ...
    var d,
      e = +new Date();
    uf && uf.time > e - 400 && 0 == rf(uf.pos, c)
      ? (d = "triple")
      : tf && tf.time > e - 400 && 0 == rf(tf.pos, c)
      ? ((d = "double"), (uf = { time: e, pos: c }))
      : ((d = "single"), (tf = { time: e, pos: c }));
    var f = a.doc.sel,
    ...
    var e = a.display,
      f = ib(a, function(g) {
        $e && (e.scroller.draggable = !1),
          ...
          Math.abs(b.clientX - g.clientX) + Math.abs(b.clientY - g.clientY) <
            10 &&
            (eg(g),
            d || ea(a.doc, c),
            yb(a),
  ...
  function Ib(a, b, c, d, e) {
      ...
      if (0 != rf(p, b))
        if (((p = b), "rect" == d)) {
          for (
            var e = [],
              f = a.options.tabSize,
              g = qg(Dd(j, c.line).text, c.ch, f),
              h = qg(Dd(j, b.line).text, b.ch, f),
              i = Math.min(g, h),
              n = Math.max(g, h),
              o = Math.min(c.line, b.line),
            ...
            var r = Dd(j, o).text,
              s = ie(r, i, f);
            i == n
              ? e.push(new X(qf(o, s), qf(o, s)))
              : r.length > s && e.push(new X(qf(o, s), qf(o, ie(r, n, f))));
          }
          ...
          var t = k,
            ...
            v = b;
          if ("single" != d) {
            if ("double" == d) var w = yc(a, b);
            else var w = new X(qf(b.line, 0), _(j, qf(b.line + 1, 0)));
            rf(w.anchor, u) > 0
              ? ((v = w.head), (u = V(t.from(), w.anchor)))
              : ((v = w.anchor), (u = U(t.to(), w.head)));
          }
          var e = m.ranges.slice(0);
          (e[l] = new X(_(j, u), v)), ka(j, Y(e, l), og);
        }
    }
    function g(b) {
      var c = ++r,
      ...
      if (e)
        if (0 != rf(e, p)) {
          ...
          k &&
            setTimeout(
              ib(a, function() {
                r == c && ((i.scroller.scrollTop += k), g(b));
              }),
              50
            );
        }
    ...
    if (
      (e && !b.shiftKey
        ? ((l = j.sel.contains(c)),
          (k = l > -1 ? j.sel.ranges[l] : new X(c, c)))
        : (k = j.sel.primary()),
      b.altKey)
    )
      (d = "rect"), e || (k = new X(c, c)), (c = Eb(a, b, !0, !0)), (l = -1);
    else if ("double" == d) {
      var n = yc(a, c);
    ...
    e
      ? l > -1
        ? ga(j, l, k, og)
        : ((l = j.sel.ranges.length),
          ka(j, Y(j.sel.ranges.concat([k]), l), {
            scroll: !1,
            origin: "*mouse"
          }))
      : ((l = 0), ka(j, new W([k], 0), og), (m = j.sel));
    var p = c,
      ...
      u = ib(a, h);
    hg(document, "mousemove", t), hg(document, "mouseup", u);
  }
  function Jb(a, b, c, d, e) {
    ...
    if (g > i.bottom || !fe(a, c)) return $d(b);
      ...
      if (c && !Ab(b))
        if (d && d.length && window.FileReader && window.File)
          ...
          if (b.state.draggingText && b.doc.sel.contains(c) > -1)
            return b.state.draggingText(a), void setTimeout(pe(yb, b), 20);
          try {
  ...
  function Mb(a, b) {
    ...
    if (
      ...
      (c.src =
        "tiles:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
        bf &&
          ((c.width = c.height = 1),
  ...
  function Pb(a, b) {
    ...
    if (
      ...
      (d && f.scrollHeight > f.clientHeight)
    ) {
      if (d && jf && $e)
        ...
        return (
          d &&
            Nb(
              ...
              Math.max(
                0,
                Math.min(f.scrollTop + d * Bf, f.scrollHeight - f.clientHeight)
              )
            ),
          Ob(
            a,
            Math.max(
              0,
              Math.min(f.scrollLeft + c * Bf, f.scrollWidth - f.clientWidth)
            )
          ),
          eg(b),
      ...
      if (d && null != Bf) {
        ...
        0 > j
          ? (k = Math.max(0, k + j - 50))
          : (l = Math.min(a.doc.height, l + j + 50)),
          A(a, { top: k, bottom: l });
      }
      20 > Af &&
        (null == e.wheelStartX
            ...
            setTimeout(function() {
              if (null != e.wheelStartX) {
                ...
                (e.wheelStartX = e.wheelStartY = null),
                  c && ((Bf = (Bf * Af + c) / (Af + 1)), ++Af);
              }
            }, 200))
          : ((e.wheelDX += c), (e.wheelDY += d)));
    }
  }
  function Qb(a, b, c) {
    if ("string" == typeof b && ((b = Pf[b]), !b)) return !1;
  ...
  function Sb(a, b) {
    ...
    clearTimeout(Cf),
      d &&
        ...
        (Cf = setTimeout(function() {
          Ac(a.options.keyMap) == c &&
            ((a.options.keyMap = d.call ? d.call(null, a) : d), h(a));
        }, 50));
    var e = Tf(b, !0),
      f = !1;
    if (!e) return !1;
    ...
    return (
      ...
      f && (eg(b), ua(a), be(a, "keyHandled", a, e, b)),
      f
    );
  }
  function Tb(a, b, c) {
    ...
    return d && (eg(b), ua(a), be(a, "keyHandled", a, "'" + c + "'", b)), d;
  }
  function Ub(a) {
    var b = this;
    if ((zb(b), !de(b, a))) {
  ...
  function Wb(a) {
    16 == a.keyCode && (this.doc.sel.shift = !1), de(this, a);
  }
  function Xb(a) {
    var b = this;
    if (!(de(b, a) || (a.ctrlKey && !a.altKey) || (jf && a.metaKey))) {
      var c = a.keyCode,
        d = a.charCode;
      if (bf && c == Df) return (Df = null), void eg(a);
      if (!((bf && (!a.which || a.which < 10)) || df) || !Sb(b, a)) {
        var e = String.fromCharCode(null == d ? c : d);
        Tb(b, a, e) ||
          (Ye && Ze >= 9 && (b.display.inputHasSelection = null), vb(b));
      }
    }
  }
  function Yb(a) {
  ...
  function $b(a, b) {
    ...
    function d() {
      if (
        ...
        var b = 0,
          d = function() {
            e.selForContextMenu == a.doc.sel && 0 == e.input.selectionStart
              ? ib(a, Pf.selectAll)(a)
              : b++ < 10
              ? (e.detectingSelectAll = setTimeout(d, 500))
              : xb(a);
          };
        ...
        if (f && !bf) {
          ...
          if (
            ...
            (e.input.style.cssText =
              ...
              (Ye ? "rgba(255, 255, 255, .05)" : "transparent") +
          ...
          if (
            ...
            gg(b);
            var k = function() {
              ig(window, "mouseup", k), setTimeout(d, 20);
            };
            hg(window, "mouseup", k);
  ...
  function _b(a, b) {
    return fe(a, "gutterContextMenu")
      ? Jb(a, b, "gutterContextMenu", !1, jg)
      : !1;
  }
  function ac(a, b) {
    if (rf(a, b.from) < 0) return a;
    if (rf(a, b.to) <= 0) return Ef(b);
    var c = a.line + b.text.length - (b.to.line - b.from.line) - 1,
      d = a.ch;
    return a.line == b.to.line && (d += Ef(b).ch - b.to.ch), qf(c, d);
  }
  function bc(a, b) {
  ...
  function cc(a, b, c) {
    return a.line == b.line
      ? qf(c.line, a.ch - b.ch + c.ch)
      : qf(c.line + (a.line - b.line), a.ch);
  }
  function dc(a, b, c) {
  ...
  function fc(a, b, c) {
    if (a.cm) {
      if (!a.cm.curOp) return ib(a.cm, fc)(a, b, c);
      if (a.cm.state.suppressEdits) return;
    }
    if (
      !(fe(a, "beforeChange") || (a.cm && fe(a.cm, "beforeChange"))) ||
      (b = ec(a, b, !0))
    ) {
      var d = of && !c && Pc(a, b.from, b.to);
      if (d)
        for (var e = d.length - 1; e >= 0; --e)
          gc(a, { from: d[e].from, to: d[e].to, text: e ? [""] : b.text });
      else gc(a, b);
    }
  }
  function gc(a, b) {
    if (1 != b.text.length || "" != b.text[0] || 0 != rf(b.from, b.to)) {
      var c = bc(a, b);
      Pd(a, b, c, a.cm ? a.cm.curOp.id : NaN), jc(a, b, c, Mc(a, b));
      var d = [];
      Bd(a, function(a, c) {
        c || -1 != le(d, a.history) || (Zd(a.history, b), d.push(a.history)),
          jc(a, b, null, Mc(a, b));
      });
    }
  }
    ...
    if (!a.cm || !a.cm.state.suppressEdits) {
      for (
        var d,
          e = a.history,
          f = a.sel,
          g = "undo" == b ? e.done : e.undone,
          h = "undo" == b ? e.undone : e.done,
          i = 0;
        i < g.length &&
        ((d = g[i]), c ? !d.ranges || d.equals(a.sel) : d.ranges);
        i++
      );
      if (i != g.length) {
        for (e.lastOrigin = e.lastSelOrigin = null; (d = g.pop()), d.ranges; ) {
          if ((Sd(d, h), c && !d.equals(a.sel)))
            return void ka(a, d, { clearRedo: !1 });
          f = d;
        }
        var j = [];
        Sd(f, h),
          h.push({ changes: j, generation: e.generation }),
          (e.generation = d.generation || ++e.maxGeneration);
        for (
          var k = fe(a, "beforeChange") || (a.cm && fe(a.cm, "beforeChange")),
            i = d.changes.length - 1;
          i >= 0;
          --i
        ) {
          var l = d.changes[i];
          if (((l.origin = b), k && !ec(a, l, !1))) return void (g.length = 0);
          j.push(Md(a, l));
          var m = i ? bc(a, l) : ke(g);
          jc(a, l, m, Oc(a, l)), !i && a.cm && a.cm.scrollIntoView(l);
          var n = [];
          Bd(a, function(a, b) {
            b ||
              -1 != le(n, a.history) ||
              (Zd(a.history, l), n.push(a.history)),
              jc(a, l, null, Oc(a, l));
          });
        }
      }
  ...
  function ic(a, b) {
    if (
      ...
      ((a.first += b),
      (a.sel = new W(
        me(a.sel.ranges, function(a) {
          return new X(
            qf(a.anchor.line + b, a.anchor.ch),
            qf(a.head.line + b, a.head.ch)
          );
        }),
        a.sel.primIndex
      )),
  ...
  function kc(a, b, c) {
    ...
    a.options.lineWrapping ||
      ...
      yd(d, b, c, f(a)),
      a.options.lineWrapping ||
        (d.iter(j, g.line + b.text.length, function(a) {
          var b = m(a);
          b > e.maxLineLength &&
            ((e.maxLine = a),
            (e.maxLineLength = b),
    ...
    g.line != h.line || 1 != b.text.length || xd(a.doc, b)
      ? nb(a, g.line, h.line + 1, k)
      : ob(a, g.line, "text");
    var l = fe(a, "changes"),
      n = fe(a, "change");
    if (n || l) {
  ...
  function lc(a, b, c, d, e) {
    ...
    "string" == typeof b && (b = Cg(b)),
      fc(a, { from: c, to: d, text: b, origin: e });
  }
  function mc(a, b) {
    var c = a.display,
    ...
    if (
      ...
      var f = te(
        ...
        "position: absolute; top: " +
          (b.top - c.viewOffset - za(a.display)) +
          "px; height: " +
          (b.bottom - b.top + lg) +
          "px; left: " +
          b.left +
  ...
  function nc(a, b, c, d) {
    for (null == d && (d = 0); ; ) {
      ...
      if (
        (null != h.scrollTop &&
          (Nb(a, h.scrollTop), Math.abs(a.doc.scrollTop - i) > 1 && (e = !0)),
        null != h.scrollLeft &&
          (Ob(a, h.scrollLeft), Math.abs(a.doc.scrollLeft - j) > 1 && (e = !0)),
        !e)
      )
        return f;
    }
  ...
  function rc(a) {
    ...
    var b = a.getCursor(),
      ...
      d = b;
    a.options.lineWrapping ||
      ((c = b.ch ? qf(b.line, b.ch - 1) : b), (d = qf(b.line, b.ch + 1))),
      (a.curOp.scrollToPos = {
        from: c,
        to: d,
  ...
  function tc(a, b, c, d) {
    ...
    if (d || /\S/.test(h.text)) {
      if (
        "smart" == c &&
        ((j = f.mode.indent(e, h.text.slice(k.length), h.text)),
        j == mg || j > 150)
      ) {
        if (!d) return;
        c = "prev";
    ...
    "prev" == c
      ? (j = b > f.first ? qg(Dd(f, b - 1).text, null, g) : 0)
      : "add" == c
      ? (j = i + a.options.indentUnit)
      : "subtract" == c
      ? (j = i - a.options.indentUnit)
      : "number" == typeof c && (j = i + c),
      (j = Math.max(0, j));
    var l = "",
      m = 0;
  ...
  function uc(a, b, c, d) {
    var e = b,
      f = b;
    return (
      "number" == typeof b ? (f = Dd(a, $(a, b))) : (e = Hd(b)),
      null == e ? null : (d(f, e) && a.cm && ob(a.cm, e, c), f)
    );
  }
  function vc(a, b) {
  ...
  function xc(a, b, c, d) {
    ...
    if ("page" == d) {
      ...
      e = b.top + c * (h - (0 > c ? 1.5 : 0.5) * Ya(a.display));
  ...
  function Bc(a, b, c, d, e) {
    if (d && d.shared) return Cc(a, b, c, d, e);
    if (a.cm && !a.cm.curOp) return ib(a.cm, Bc)(a, b, c, d, e);
    var f = new Vf(a, e),
      g = rf(b, c);
    if ((d && oe(d, f, !1), g > 0 || (0 == g && f.clearWhenEmpty !== !1)))
      return f;
    if (
      (f.replacedWith &&
        ((f.collapsed = !0),
      ...
      if (
        Yc(a, b.line, b, c, f) ||
        (b.line != c.line && Yc(a, c.line, b, c, f))
      )
        throw new Error(
    ...
    f.addToHistory && Pd(a, { from: b, to: c, origin: "markText" }, a.sel, NaN);
    var h,
      i = b.line,
      j = a.cm;
    if (
      (a.iter(i, c.line + 1, function(a) {
        j &&
          f.collapsed &&
          !j.options.lineWrapping &&
          Zc(a) == j.display.maxLine &&
          (h = !0),
          f.collapsed && i != b.line && Gd(a, 0),
          Jc(
            a,
            new Gc(f, i == b.line ? b.ch : null, i == c.line ? c.ch : null)
          ),
          ++i;
      }),
      f.collapsed &&
      ...
      f.collapsed && ((f.id = ++Wf), (f.atomic = !0)),
      j)
    ) {
      ...
      f.atomic && na(j.doc), be(j, "markerAdded", j, f);
    }
    return f;
  }
  ...
  function Dc(a) {
    return a.findMarks(qf(a.first, 0), a.clipPos(qf(a.lastLine())), function(
      a
    ) {
      return a.parent;
    });
  ...
  function Fc(a) {
    for (var b = 0; b < a.length; b++) {
      ...
      for (var e = 0; e < c.markers.length; e++) {
        var f = c.markers[e];
        -1 == le(d, f.doc) && ((f.parent = null), c.markers.splice(e--, 1));
      }
    }
  }
  function Gc(a, b, c) {
    ...
    if (a)
      for (var d, e = 0; e < a.length; ++e) {
        ...
        if (
          ...
          (d || (d = [])).push(
            new Gc(g, i ? null : f.from - b, null == f.to ? null : f.to - b)
          );
        }
      }
    return d;
  ...
  function Mc(a, b) {
    ...
    if (!j) {
      ...
      if (q > 0 && h)
        for (var l = 0; l < h.length; ++l)
          null == h[l].to &&
            (p || (p = [])).push(new Gc(h[l].marker, null, null));
  ...
  function Zc(a) {
    for (var b; (b = Wc(a)); ) a = b.find(-1, !0).line;
    return a;
  }
  function $c(a) {
    for (var b, c; (b = Xc(a)); )
  ...
  function dd(a, b, c) {
    Jd(b) < ((a.curOp && a.curOp.scrollTop) || a.doc.scrollTop) &&
      qc(a, null, c);
  }
  function ed(a) {
  ...
  function ld(b, c, d, e, f, g, h) {
    ...
    var j,
      k = 0,
      l = null,
      m = new Uf(c, b.options.tabSize);
    for ("" == c && id(jd(d, e), g); !m.eol(); ) {
      if (
        (m.pos > b.options.maxHighlightLength
          ? ((i = !1), h && od(b, c, e, m.pos), (m.pos = c.length), (j = null))
          : (j = id(kd(d, m, e), g)),
      ...
      (i && l == j) || (k < m.start && f(m.start, l), (k = m.start), (l = j)),
        (m.start = m.pos);
    }
    for (; k < m.pos; ) {
  ...
  function od(a, b, c, d) {
    ...
    for (
      f.start = f.pos = d || 0, "" == b && jd(e, c);
      !f.eol() && f.pos <= a.options.maxHighlightLength;

    )
      kd(e, f, c), (f.start = f.pos);
  }
  function pd(a, b) {
  ...
  function qd(a, b) {
    var c = te("span", null, null, $e ? "padding-right: .1px" : null),
      d = { pre: te("pre", [c]), content: c, col: 0, pos: 0, cm: a };
    b.measure = {};
    for (var e = 0; e <= (b.rest ? b.rest.length : 0); e++) {
      ...
      (d.pos = 0),
        ...
        (Ye || $e) &&
          ...
          (d.addToken = td(d.addToken)),
        He(a.display.measure) &&
          (f = Kd(g)) &&
          (d.addToken = ud(d.addToken, f)),
        (d.map = []),
        wd(g, d, nd(a, g)),
        g.styleClasses &&
          (g.styleClasses.bgClass &&
            (d.bgClass = Be(g.styleClasses.bgClass, d.bgClass || "")),
          g.styleClasses.textClass &&
            (d.textClass = Be(g.styleClasses.textClass, d.textClass || ""))),
        0 == d.map.length &&
          d.map.push(0, 0, d.content.appendChild(Ge(a.display.measure))),
        0 == e
    ...
    return (
      jg(a, "renderLine", a, b.line, d.pre),
  ...
  function wd(a, b, c) {
    ...
    if (d)
      for (
        var g, h, i, j, k, l, m = e.length, n = 0, o = 1, p = "", q = 0;
        ;
        ...
        if (q == n) {
          ...
          for (var r = [], s = 0; s < d.length; ++s) {
            var t = d[s],
              u = t.marker;
            t.from <= n && (null == t.to || t.to > n)
              ? (null != t.to && q > t.to && ((q = t.to), (i = "")),
                u.className && (h += " " + u.className),
                u.startStyle && t.from == n && (j += " " + u.startStyle),
                u.endStyle && t.to == q && (i += " " + u.endStyle),
                u.title && !k && (k = u.title),
                u.collapsed && (!l || Uc(l.marker, u) < 0) && (l = t))
              : t.from > n && q > t.from && (q = t.from),
              "bookmark" == u.type && t.from == n && u.widgetNode && r.push(u);
          }
          if (
            l &&
            (l.from || 0) == n &&
            (vd(b, (null == l.to ? m + 1 : l.to) - n, l.marker, null == l.from),
            null == l.to)
          )
            return;
          if (!l && r.length) for (var s = 0; s < r.length; ++s) vd(b, 0, r[s]);
        }
        if (n >= m) break;
        for (var v = Math.min(m, q); ; ) {
          ...
          (p = e.slice(f, (f = c[o++]))), (g = pd(c[o++], b.cm.options));
        }
      }
    else
  ...
  function Hd(a) {
    ...
    for (
      var b = a.parent, c = le(b.lines, a), d = b.parent;
      d;
      b = d, d = d.parent
    )
  ...
  function Kd(a) {
    var b = a.order;
    return null == b && (b = a.order = Ig(a.text)), b;
  }
  function Ld(a) {
    (this.done = []),
      (this.undone = []),
  ...
  function Md(a, b) {
    var c = { from: T(b.from), to: Ef(b), text: Ed(a, b.from, b.to) };
    return (
  ...
  function Od(a, b) {
    return b
      ? (Nd(a.done), ke(a.done))
      : a.done.length && !ke(a.done).ranges
      ? ke(a.done)
      : a.done.length > 1 && !a.done[a.done.length - 2].ranges
      ? (a.done.pop(), ke(a.done))
      : void 0;
  }
  function Pd(a, b, c, d) {
    var e = a.history;
    ...
    if (
      (e.lastOp == d ||
        (e.lastOrigin == b.origin &&
          ...
          (("+" == b.origin.charAt(0) &&
            a.cm &&
            e.lastModTime > g - a.cm.options.historyEventDelay) ||
            "*" == b.origin.charAt(0)))) &&
      (f = Od(e, e.lastOp == d))
    ) {
      var h = ke(f.changes);
      0 == rf(b.from, b.to) && 0 == rf(b.from, h.to)
        ? (h.to = Ef(b))
        : f.changes.push(Md(a, b));
    } else {
      var i = ke(e.done);
      for (
        (i && i.ranges) || Sd(a.sel, e.done),
          f = { changes: [Md(a, b)], generation: e.generation },
          e.done.push(f);
  ...
  function Vd(a, b) {
    var c = b["spans_" + a.id];
    if (!c) return null;
    for (var d = 0, e = []; d < b.text.length; ++d) e.push(Ud(c[d]));
    return e;
  }
  function Wd(a, b, c) {
    for (var d = 0, e = []; d < a.length; ++d) {
      var f = a[d];
      if (f.ranges) e.push(c ? W.prototype.deepCopy.call(f) : f);
      else {
        var g = f.changes,
          h = [];
        e.push({ changes: h });
    ...
    for (var e = 0; e < a.length; ++e) {
      ...
      if (f.ranges) {
        ...
        for (var h = 0; h < f.ranges.length; h++)
          Xd(f.ranges[h].anchor, b, c, d), Xd(f.ranges[h].head, b, c, d);
      } else {
  ...
  function Zd(a, b) {
    ...
    Yd(a.done, c, d, e), Yd(a.undone, c, d, e);
  }
  function $d(a) {
  ...
  function be(a, b) {
    ...
    if (d) {
      ...
      wf
        ? (e = wf.delayedCallbacks)
        : kg
        ? (e = kg)
        : ((e = kg = []), setTimeout(ce, 0));
  ...
  function de(a, b, c) {
    return jg(a, c || b.type, a, b), $d(b) || b.codemirrorIgnore;
  }
  function ee(a) {
  ...
  function Fe(a) {
    ...
    return (
      ve(a, b), b.offsetWidth && (xg = b.offsetHeight - b.clientHeight), xg || 0
    );
  }
  function Ge(a) {
    if (null == yg) {
      ...
      ve(a, te("span", [b, document.createTextNode("x")])),
        0 != a.firstChild.offsetHeight &&
          (yg = b.offsetWidth <= 1 && b.offsetHeight > 2 && !(Ye && 8 > Ze));
    }
    return yg
      ? te("span", "​")
      : te(
  ...
  function Te(a, b, c, d) {
    ...
    for (
      var f = Re(e, b), g = e[f], h = Se(a, b, g.level % 2 ? -c : c, d);
      ;
  ...
  function Ue(a, b, c, d) {
    var e = b + c;
    if (d) for (; e > 0 && se(a.text.charAt(e)); ) e += c;
  ...
  lf && (lf = Number(lf[1])), lf && lf >= 15 && ((bf = !1), ($e = !0));
  ...
  (W.prototype = {
    ...
    equals: function(a) {
      ...
      for (var b = 0; b < this.ranges.length; b++) {
        var c = this.ranges[b],
          d = a.ranges[b];
        if (0 != rf(c.anchor, d.anchor) || 0 != rf(c.head, d.head)) return !1;
      }
      return !0;
    },
    deepCopy: function() {
    ...
    contains: function(a, b) {
      ...
      for (var c = 0; c < this.ranges.length; c++) {
        var d = this.ranges[c];
        if (rf(b, d.from()) >= 0 && rf(a, d.to()) <= 0) return c;
      }
      return -1;
    }
  }),
  ...
  var sf,
    tf,
    uf,
    vf = { left: 0, right: 0, top: 0, bottom: 0 },
    wf = null,
    xf = 0,
    yf = null,
    zf = 0,
    Af = 0,
    Bf = null;
  Ye ? (Bf = -0.53) : Ve ? (Bf = 15) : af ? (Bf = -0.7) : cf && (Bf = -1 / 3);
  var Cf,
    Df = null,
    Ef = (a.changeEnd = function(a) {
      return a.text
        ? qf(
            a.from.line + a.text.length - 1,
            ke(a.text).length + (1 == a.text.length ? a.from.ch : 0)
          )
        : a.to;
    });
  (a.prototype = {
    ...
    setOption: function(a, b) {
      var c = this.options,
        d = c[a];
      (c[a] != b || "mode" == a) &&
        ((c[a] = b), Gf.hasOwnProperty(a) && ib(this, Gf[a])(this, b, d));
    },
    ...
    addOverlay: jb(function(b, c) {
      ...
      this.state.overlays.push({ mode: d, modeSpec: b, opaque: c && c.opaque }),
        this.state.modeGen++,
        nb(this);
    }),
    removeOverlay: jb(function(a) {
      for (var b = this.state.overlays, c = 0; c < b.length; ++c) {
        ...
        if (d == a || ("string" == typeof a && d.name == a))
          return b.splice(c, 1), this.state.modeGen++, void nb(this);
      }
    }),
    ...
    getTokenAt: function(a, b) {
      ...
      a = _(c, a);
      for (
        var d = ya(this, a.line, b),
          e = this.doc.mode,
          f = Dd(c, a.line),
          g = new Uf(f.text, this.options.tabSize);
        g.pos < a.ch && !g.eol();
    ...
    getHelpers: function(a, b) {
      var c = [];
      if (!Mf.hasOwnProperty(b)) return Mf;
      var d = Mf[b],
        e = this.getModeAt(a);
    ...
    getStateAfter: function(a, b) {
      var c = this.doc;
      return (
        (a = $(c, null == a ? c.first + c.size - 1 : a)), ya(this, a + 1, b)
      );
    },
    ...
    lineAtHeight: function(a, b) {
      return (
        (a = Ra(this, { top: a, left: 0 }, b || "page").top),
    ...
    heightAtLine: function(a, b) {
      ...
      var e = Dd(this.doc, a);
      return (
        Qa(this, e, { top: 0, left: 0 }, b || "page").top +
        (c ? this.doc.height - Jd(e) : 0)
      );
    },
    ...
    setGutterMarker: jb(function(a, b, c) {
      return uc(this.doc, a, "gutter", function(a) {
        ...
        return (d[b] = c), !c && re(d) && (a.gutterMarkers = null), !0;
      });
    }),
    ...
    lineInfo: function(a) {
      if ("number" == typeof a) {
        ...
        var b = a;
        if (((a = Dd(this.doc, a)), !a)) return null;
      } else {
        var b = Hd(a);
    ...
    moveH: jb(function(a, b) {
      ...
      c.extendSelectionsBy(function(d) {
        return c.display.shift || c.doc.extend || d.empty()
          ? wc(c.doc, d.head, a, b, c.options.rtlMoveVisually)
          : 0 > a
          ? d.from()
          : d.to();
      }, pg);
      ...
      if (
        (d.extendSelectionsBy(function(g) {
          ...
          return (
            "page" == b &&
              g == d.sel.primary() &&
              qc(c, null, Sa(c, i, "div").top - h.top),
            i
          );
        }, pg),
        e.length)
    ...
    toggleOverwrite: function(a) {
      (null == a || a != this.state.overwrite) &&
        ((this.state.overwrite = !this.state.overwrite)
          ...
          : ze(this.display.cursorDiv, "CodeMirror-overwrite"),
    ...
    scrollIntoView: jb(function(a, b) {
      if (
        (null == a
          ...
          : "number" == typeof a
          ? (a = { from: qf(a, 0), to: null })
          : null == a.from && (a = { from: a, to: null }),
        a.to || (a.to = a.from),
        (a.margin = b || 0),
        null != a.from.line)
      )
        sc(this), (this.curOp.scrollToPos = a);
      else {
        var c = pc(
          this,
    ...
    refresh: jb(function() {
      ...
      nb(this),
        ...
        l(this),
        (null == a || Math.abs(a - Ya(this.display)) > 0.5) && g(this),
  ...
  zc(
    ...
    zc("readOnly", !1, function(a, b) {
      "nocursor" == b
        ? (Zb(a), a.display.input.blur(), (a.display.disabled = !0))
        : ((a.display.disabled = !1), b || xb(a));
    }),
    zc(
      "disableInput",
      !1,
  ...
  (a.defineMode = function(b, c) {
    ...
    (a.resolveMode = function(b) {
      if ("string" == typeof b && Jf.hasOwnProperty(b)) b = Jf[b];
  ...
  (a.registerHelper = function(b, c, d) {
    ...
    (a.registerGlobalHelper = function(b, c, d, e) {
      a.registerHelper(b, c, e), Mf[b]._global.push({ pred: d, val: e });
    });
  ...
  var Pf = (a.commands = {
        ...
        vc(a, function(b) {
          if (b.empty()) {
            ...
            return b.head.ch == c && b.head.line < a.lastLine()
              ? { from: b.head, to: qf(b.head.line + 1, 0) }
              : { from: b.head, to: qf(b.head.line, c) };
          }
      ...
      delLineLeft: function(a) {
        vc(a, function(a) {
          return { from: qf(a.from().line, 0), to: a.from() };
        });
      },
      ...
      transposeChars: function(a) {
        hb(a, function() {
          for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
            ...
            if (f)
              if (
                (e.ch == f.length && (e = new qf(e.line, e.ch - 1)), e.ch > 0)
              )
  ...
  var Rf = (a.lookupKey = function(a, b, c) {
    ...
    Tf = (a.keyName = function(a, b) {
      if (bf && 34 == a.keyCode && a["char"]) return !1;
      var c = Gg[a.keyCode];
  ...
  a.fromTextArea = function(b, c) {
    ...
    if (b.form && (hg(b.form, "submit", d), !c.leaveSubmitMethodAlone)) {
      var f = b.form,
        g = f.submit;
      try {
    ...
    column: function() {
      return (
        this.lastColumnPos < this.start &&
          ...
          (this.lastColumnPos = this.start)),
        this.lastColumnValue -
          (this.lineStart ? qg(this.string, this.lineStart, this.tabSize) : 0)
      );
    },
    indentation: function() {
      return (
        qg(this.string, null, this.tabSize) -
        (this.lineStart ? qg(this.string, this.lineStart, this.tabSize) : 0)
      );
    },
  ...
  ge(Vf),
    (Vf.prototype.clear = function() {
      if (!this.explicitlyCleared) {
        ...
        for (var d = null, e = null, f = 0; f < this.lines.length; ++f) {
          ...
          a && !this.collapsed
            ? ob(a, Hd(g), "text")
            : a && (null != h.to && (e = Hd(g)), null != h.from && (d = Hd(g))),
        ...
        null != d && a && this.collapsed && nb(a, d, e + 1),
          ...
          this.atomic &&
            this.doc.cantEdit &&
            ((this.doc.cantEdit = !1), a && na(a.doc)),
    ...
    (Vf.prototype.find = function(a, b) {
      ...
      for (var c, d, e = 0; e < this.lines.length; ++e) {
        ...
        if (null != g.from && ((c = qf(b ? f : Hd(f), g.from)), -1 == a))
          return c;
        if (null != g.to && ((d = qf(b ? f : Hd(f), g.to)), 1 == a)) return d;
      }
    ...
    (Vf.prototype.changed = function() {
      ...
      a &&
        ...
        hb(c, function() {
          ...
          if (
            (f &&
              (La(f), (c.curOp.selectionChanged = c.curOp.forceUpdate = !0)),
    ...
    (Vf.prototype.attachLine = function(a) {
      if (!this.lines.length && this.doc.cm) {
        ...
        (b.maybeHiddenMarkers && -1 != le(b.maybeHiddenMarkers, this)) ||
    ...
    (Vf.prototype.detachLine = function(a) {
      if (
        (this.lines.splice(le(this.lines, a), 1),
  ...
  ge(Yf),
    (Yf.prototype.clear = function() {
      ...
      if (null != d && b) {
        ...
        var f = ed(this);
        hb(a, function() {
          dd(a, c, -f), ob(a, d, "widget"), Gd(c, Math.max(0, c.height - f));
        });
      }
    }),
    (Yf.prototype.changed = function() {
      ...
      d &&
        hb(b, function() {
          (b.curOp.forceUpdate = !0), dd(b, c, d), Gd(c, c.height + d);
        });
    });
  var Zf = (a.Line = function(a, b, c) {
    (this.text = a), Rc(this, b), (this.height = c ? c(this) : 1);
  });
  ge(Zf),
  ...
  (zd.prototype = {
    ...
    removeInner: function(a, b) {
      for (var c = a, d = a + b; d > c; ++c) {
        var e = this.lines[c];
        (this.height -= e.height), hd(e), be(e, "delete");
      }
    ...
    (Ad.prototype = {
      ...
      removeInner: function(a, b) {
        ...
        if (
          this.size - b < 25 &&
          (this.children.length > 1 || !(this.children[0] instanceof zd))
        ) {
          var h = [];
          this.collapse(h),
  ...
  var ag = 0,
    bg = (a.Doc = function(a, b, c) {
      if (!(this instanceof bg)) return new bg(a, b, c);
      null == c && (c = 0),
  ...
  (bg.prototype = ne(Ad.prototype, {
    ...
    getLineHandleVisualStart: function(a) {
      return "number" == typeof a && (a = Dd(this, a)), Zc(a);
    },
    lineCount: function() {
      return this.size;
    },
    ...
    replaceSelections: kb(function(a, b, c) {
      for (var d = [], e = this.sel, f = 0; f < e.ranges.length; f++) {
        var g = e.ranges[f];
        d[f] = { from: g.from(), to: g.to(), text: Cg(a[f]), origin: c };
      }
      for (
        var h = b && "end" != b && dc(this, d, b), f = d.length - 1;
        f >= 0;
        f--
      )
        fc(this, d[f]);
    ...
    getHistory: function() {
      return { done: Wd(this.history.done), undone: Wd(this.history.undone) };
    },
    ...
    setBookmark: function(a, b) {
      ...
      return (a = _(this, a)), Bc(this, a, a, c, "bookmark");
    },
    ...
    copy: function(a) {
      var b = new bg(
        Fd(this, this.first, this.first + this.size),
        this.modeOption,
        this.first
      );
      return (
    ...
    unlinkDoc: function(b) {
      if ((b instanceof a && (b = b.doc), this.linked))
        for (var c = 0; c < this.linked.length; ++c) {
          var d = this.linked[c];
          if (d.doc == b) {
            this.linked.splice(c, 1), b.unlinkDoc(this), Fc(Dc(this));
            break;
          }
        }
  ...
  for (var dg in bg.prototype)
    bg.prototype.hasOwnProperty(dg) &&
      le(cg, dg) < 0 &&
  ...
  var tg,
    ...
    vg = (a.isWordChar = function(a) {
      return (
        /\w/.test(a) ||
        (a > "" && (a.toUpperCase() != a.toLowerCase() || ug.test(a)))
      );
    }),
  ...
  (a.keyNames = Gg),
    (function() {
      for (var a = 0; 10 > a; a++) Gg[a + 48] = Gg[a + 96] = String(a);
      for (var a = 65; 90 >= a; a++) Gg[a] = String.fromCharCode(a);
      for (var a = 1; 12 >= a; a++) Gg[a + 111] = Gg[a + 63235] = "F" + a;
    })();
  var Hg,
    Ig = (function() {
      function a(a) {
      ...
      return function(c) {
        ...
        for (var m = 0, o = j; k > m; ++m) {
          ...
          "1" == d && "r" == o
            ? (l[m] = "n")
            : g.test(d) && ((o = d), "r" == d && (l[m] = "R"));
        }
        for (var m = 1, n = l[0]; k - 1 > m; ++m) {
          var d = l[m];
          "+" == d && "1" == n && "1" == l[m + 1]
            ? (l[m] = "1")
            : "," != d || n != l[m + 1] || ("1" != n && "n" != n) || (l[m] = n),
            (n = d);
        }
        for (var m = 0; k > m; ++m) {
          var d = l[m];
        ...
        return (
          1 == v[0].level &&
            (u = c.match(/^\s+/)) &&
            ((v[0].from = u[0].length), v.unshift(new b(0, 0, u[0].length))),
          1 == ke(v).level &&
            (u = c.match(/\s+$/)) &&
            ((ke(v).to -= u[0].length), v.push(new b(0, k - u[0].length, k))),
          v[0].level != ke(v).level && v.push(new b(v[0].level, k, k)),
          v
        );
      };
    })();
  return (a.version = "4.4.0"), a;
}),
  (function(a) {
    ...
    a.defineMode("javascript", function(b, c) {
      ...
      function f(a, b) {
        ...
        if ("/" == c)
          return a.eat("*")
            ...
            : (a.eatWhile(va), e("operator", "operator", a.current()));
        if ("`" == c) return (b.tokenize = i), i(a, b);
        if ("#" == c) return a.skipToEnd(), e("error", "error");
        if (va.test(c))
          return a.eatWhile(va), e("operator", "operator", a.current());
        a.eatWhile(/[\w\$_]/);
        var f = a.current(),
          j = ua.propertyIsEnumerable(f) && ua[f];
        return j && "." != b.lastType
          ? e(j.type, j.style, f)
          : e("variable", "variable", f);
      }
      function g(a) {
        return function(b, c) {
          var d,
          ...
          if (ra && "@" == b.peek() && b.match(wa))
            return (c.tokenize = f), e("jsonld-keyword", "meta");
      ...
      function p(a) {
        ...
        var d = za.state;
        if (d.context) {
          if (((za.marked = "def"), b(d.localVars))) return;
      ...
      function v(a, b) {
        return "var" == a
          ...
          ? o()
          : "if" == a
          ? ("else" == za.state.lexical.info &&
              za.state.cc[za.state.cc.length - 1] == t &&
              za.state.cc.pop()(),
            o(s("form"), w, v, t, W))
          : "function" == a
          ? o(aa)
          ...
          ? o(s("stat"), H)
          : "switch" == a
          ? o(s("form"), w, s("}", "switch"), u("{"), O, t, t)
          : "case" == a
          ? o(w, u(":"))
          : "default" == a
          ? o(u(":"))
          : "catch" == a
          ? o(s("form"), q, u("("), ba, u(")"), v, t, r)
          : "module" == a
          ? o(s("form"), q, fa, r, t)
          : "class" == a
          ? o(s("form"), ca, ea, t)
      ...
      function E(a) {
        return "}" == a
          ? ((za.marked = "string-2"), (za.state.tokenize = i), o(D))
          : void 0;
      }
      function F(a) {
        return j(za.stream, za.state), n("{" == a ? v : w);
      }
      function G(a) {
        return j(za.stream, za.state), n("{" == a ? v : x);
      }
      function H(a) {
        return ":" == a ? o(t, v) : n(B, u(";"), t);
      }
      function I(a) {
        return "variable" == a ? ((za.marked = "property"), o()) : void 0;
      }
      function J(a, b) {
        if ("variable" == a) {
          if (((za.marked = "property"), "get" == b || "set" == b)) return o(K);
        } else if ("number" == a || "string" == a)
          za.marked = ra ? "property" : a + " property";
        else if ("[" == a) return o(w, u("]"), L);
        return ya.hasOwnProperty(a) ? o(L) : void 0;
      }
      function K(a) {
        return "variable" != a ? n(L) : ((za.marked = "property"), o(aa));
      }
      function L(a) {
      ...
      function N(a, b, c) {
        for (var d = 3; d < arguments.length; d++) za.cc.push(arguments[d]);
      ...
      function Q(a) {
        return "variable" == a ? ((za.marked = "variable-3"), o()) : void 0;
      }
      function R() {
        return n(S, P, U, V);
      }
      ...
      function T(a, b) {
        return "variable" != a || za.stream.match(/^\s*:/, !1)
          ? ("variable" == a && (za.marked = "property"), o(u(":"), S, U))
          : (p(b), o(U));
      }
      function U(a, b) {
        return "=" == b ? o(x) : void 0;
      ...
      function fa(a, b) {
        return "string" == a ? o(v) : "variable" == a ? (p(b), o(ja)) : void 0;
      }
      function ga(a, b) {
        return "*" == b
          ? ((za.marked = "keyword"), o(ja, u(";")))
          : "default" == b
          ? ((za.marked = "keyword"), o(w, u(";")))
          : n(v);
      }
      function ha(a) {
      ...
      function ia(a, b) {
        return "{" == a ? N(ia, "}") : ("variable" == a && p(b), o());
      }
      function ja(a, b) {
        return "from" == b ? ((za.marked = "keyword"), o(w)) : void 0;
      }
      function ka(a) {
        return "]" == a ? o() : n(x, la);
      }
      ...
      var na,
        ...
        va = /[+\-*&%=<>!?|~^]/,
        wa = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,
        xa = "([{}])",
        ya = {
          atom: !0,
          number: !0,
        ...
        za = { state: null, column: null, marked: null, cc: null },
        Aa = { name: "this", next: { name: "arguments" } };
      return (
        (t.lex = !0),
        {
          ...
          indent: function(b, d) {
            ...
            return "vardef" == k
              ...
              : "stat" == k
              ? g.indented +
                ("operator" == b.lastType || "," == b.lastType ? qa || pa : 0)
              : "switch" != g.info || l || 0 == c.doubleIndentSwitch
              ? g.align
                ? g.column + (l ? 0 : 1)
                : g.indented + (l ? 0 : pa)
              : g.indented + (/^(?:case|default)\b/.test(d) ? pa : 2 * pa);
          },
          electricChars: ":{}",
  ...
  (function(a) {
    ...
    a.defineMode("xml", function(b, c) {
        ...
        if ("<" == d)
          return a.eat("!")
            ? a.eat("[")
              ...
              ? c(g("comment", "-->"))
              : a.match("DOCTYPE", !0, !0)
              ? (a.eatWhile(/[\w\._\-]/), c(h(1)))
              : null
            : a.eat("?")
            ? (a.eatWhile(/[\w\._\-]/), (b.tokenize = g("meta", "?>")), "meta")
            : ((x = a.eat("/") ? "closeTag" : "openTag"),
              (b.tokenize = e),
              "tag bracket");
        if ("&" == d) {
          var f;
      ...
      function e(a, b) {
        ...
        if ("=" == c) return (x = "equals"), null;
        if ("<" == c) {
          (b.tokenize = d), (b.state = l), (b.tagName = b.tagStart = null);
      ...
      function h(a) {
        return function(b, c) {
          for (var e; null != (e = b.next()); ) {
            if ("<" == e) return (c.tokenize = h(a + 1)), c.tokenize(b, c);
            if (">" == e) {
              if (1 == a) {
                c.tokenize = d;
                break;
              }
              return (c.tokenize = h(a - 1)), c.tokenize(b, c);
            }
          }
          return "meta";
        };
      ...
      function i(a, b, c) {
        (this.prev = a.context),
          ...
          (this.startOfLine = c),
          (z.doNotIndent.hasOwnProperty(b) ||
      ...
      function k(a, b) {
        for (var c; ; ) {
          ...
          if (
            ((c = a.context.tagName),
            !z.contextGrabbers.hasOwnProperty(c) ||
              !z.contextGrabbers[c].hasOwnProperty(b))
          )
            return;
          j(a);
        }
      ...
      function n(a, b, c) {
        if ("word" == a) {
          ...
          return (
            c.context &&
              c.context.tagName != d &&
              z.implicitlyClosed.hasOwnProperty(c.context.tagName) &&
              j(c),
      ...
      function o(a, b, c) {
        return "endTag" != a ? ((y = "error"), o) : (j(c), l);
      }
      function p(a, b, c) {
        return (y = "error"), o(a, b, c);
      }
      function q(a, b, c) {
        if ("word" == a) return (y = "attribute"), r;
        if ("endTag" == a || "selfcloseTag" == a) {
          var d = c.tagName,
            e = c.tagStart;
          return (
            (c.tagName = c.tagStart = null),
            "selfcloseTag" == a || z.autoSelfClosers.hasOwnProperty(d)
              ? k(c, d)
              : (k(c, d), (c.context = new i(c, d, e == c.indented))),
            l
          );
        }
        return (y = "error"), q;
      ...
      function r(a, b, c) {
        return "equals" == a
          ? s
          : (z.allowMissing || (y = "error"), q(a, b, c));
      }
      function s(a, b, c) {
        return "string" == a
          ? t
          : "word" == a && z.allowUnquoted
          ? ((y = "string"), q)
          : ((y = "error"), q(a, b, c));
      }
      function t(a, b, c) {
        ...
        indent: function(b, c, f) {
          ...
          if (h && h[1])
            for (; g; ) {
              ...
              if (!z.implicitlyClosed.hasOwnProperty(g.tagName)) break;
              g = g.prev;
            }
          else if (h)
            for (; g; ) {
  ...
  (function(a) {
    ...
    a.defineMode("css", function(b, c) {
      ...
      function e(a, b) {
        ...
        return "@" == c
          ? (a.eatWhile(/[\w\\\-]/), d("def", a.current()))
          : "=" == c || (("~" == c || "|" == c) && a.eat("="))
          ? d(null, "compare")
          : '"' == c || "'" == c
          ? ((b.tokenize = f(c)), b.tokenize(a, b))
          : "#" == c
          ? (a.eatWhile(/[\w\\\-]/), d("atom", "hash"))
          : "!" == c
          ? (a.match(/^\s*\w*/), d("keyword", "important"))
          : /\d/.test(c) || ("." == c && a.eat(/\d/))
          ? (a.eatWhile(/[\w.%]/), d("number", "unit"))
          : "-" !== c
          ? /[,+>*\/]/.test(c)
            ? d(null, "select-op")
            ...
            ? d(null, c)
            : "u" == c && a.match("rl(")
            ? (a.backUp(1), (b.tokenize = g), d("property", "word"))
            : /[\w\\\-]/.test(c)
            ? (a.eatWhile(/[\w\\\-]/), d("property", "word"))
            : d(null, null)
          : /[\d.]/.test(a.peek())
          ? (a.eatWhile(/[\w.%]/), d("number", "unit"))
          : a.match(/^\w+-/)
      ...
      function i(a, b, c) {
        return (a.context = new h(c, b.indentation() + p, a.context)), c;
      }
      function j(a) {
      ...
      var n,
        ...
        r = c.mediaTypes || {},
        s = c.mediaFeatures || {},
        t = c.propertyKeywords || {},
        u = c.nonStandardPropertyKeywords || {},
        v = c.colorKeywords || {},
        w = c.valueKeywords || {},
        x = c.fontProperties || {},
        y = c.allowNested,
      ...
      return (
        ...
        (z.prop = function(a, b, c) {
          ...
          if (
            ...
            if ("word" == a) m(b);
            else if ("interpolation" == a) return i(c, b, "interpolation");
          } else o += " error";
          return "prop";
        }),
        ...
        (z.media = function(a, b, c) {
          if ("(" == a) return i(c, b, "media_parens");
          if ("}" == a) return l(a, b, c);
          if ("{" == a) return j(c) && i(c, b, y ? "block" : "top");
          if ("word" == a) {
            var d = b.current().toLowerCase();
            o =
              "only" == d || "not" == d || "and" == d
        ...
        (z.font_face = function(a, b, c) {
          return "}" == a
            ? j(c)
            : "word" == a
            ? ((o = x.hasOwnProperty(b.current().toLowerCase())
                ? "property"
                : "error"),
              "maybeprop")
            : "font_face";
            ...
            return (
              ...
              !c.prev ||
                (("}" != d ||
                  ...
                  ("{" != d || ("at" != c.type && "media" != c.type))) ||
                ((e = c.indent - p), (c = c.prev)),
              e
            );
          },
          electricChars: "}",
    ...
    a.registerHelper("hintWords", "css", r),
      a.defineMIME("text/css", {
        ...
        tokenHooks: {
          "<": function(a, b) {
            return a.match("!--") ? ((b.tokenize = d), d(a, b)) : !1;
          },
          "/": function(a, b) {
            return a.eat("*") ? ((b.tokenize = c), c(a, b)) : !1;
          }
        },
        name: "css"
      }),
  ...
  (function(a) {
    ...
    a.defineMode(
      ...
      function(b, c) {
            ...
            for (var k = 0; k < j.length; ++k) {
              ...
              if (
                ...
                l.mode &&
                  ...
                  (b.localState =
                    l.mode.startState &&
                    l.mode.startState(h.indent(b.htmlState, ""))));
                break;
              }
            }
          } else
        ...
        function e(a, b, c) {
          ...
          return (
            f > -1
              ? a.backUp(e.length - f)
              : (d = e.match(/<\/?$/)) &&
                (a.backUp(e.length), a.match(b, !1) || a.match(e)),
            c
          );
        }
        function f(a, b) {
          return a.match(/^<\/\s*script\s*>/i, !1)
            ? ((b.token = d), (b.localState = b.localMode = null), d(a, b))
            : e(a, /<\/\s*script\s*>/, b.localMode.token(a, b.localState));
        }
        function g(a, b) {
          return a.match(/^<\/\s*style\s*>/i, !1)
            ? ((b.token = d), (b.localState = b.localMode = null), d(a, b))
            : e(a, /<\/\s*style\s*>/, i.token(a, b.localState));
        }
        var h = a.getMode(b, {
            name: "xml",
            htmlMode: !0,
        ...
        return (
          j.push({ matches: /./, mode: a.getMode(b, "text/plain") }),
          {
            startState: function() {
              var a = h.startState();
              return {
  ...
  (function(a, b) {
    ...
    var c,
      ...
      P = function() {
        return {
          ...
          flash: y(H, ["bridge"]),
          zeroclipboard: { version: Ea.version, config: Ea.config() }
        };
      },
      Q = function() {
        ...
        if (e && e.length) {
          for (c = 0, d = e.length; d > c; c++)
            (a = e[c].replace(/^on/, "")),
              ...
              J[a] || (J[a] = []),
              J[a].push(b);
          if ((f.ready && H.ready && Ea.emit({ type: "ready" }), f.error)) {
            var g = [
              "disabled",
              "outdated",
              "unavailable",
            ...
            for (c = 0, d = g.length; d > c; c++)
              if (H[g[c]] === !0) {
                Ea.emit({ type: "error", name: "flash-" + g[c] });
                break;
              }
          }
        }
        ...
        return (
          ...
          a && !ia(a)
            ? "ready" === a.type && H.overdue === !0
              ? Ea.emit({ type: "error", name: "flash-overdue" })
              : ((b = v({}, a)),
                ha.call(this, b),
                "copy" === a.type &&
                  ((d = oa(K)), (c = d.data), (L = d.formatMap)),
                c)
            : void 0
        );
      },
          ...
          "number" == typeof a &&
            ...
            g(function() {
              "boolean" != typeof H.deactivated && (H.deactivated = !0),
                H.deactivated === !0 &&
                  Ea.emit({ type: "error", name: "flash-deactivated" });
            }, a),
            (H.overdue = !1),
            ma();
        }
      ...
      W = function() {
        Ea.clearData(), Ea.blur(), Ea.emit("destroy"), na(), Ea.off();
      },
      X = function(a, b) {
        var c;
      ...
      _ = function() {
        ...
        a &&
          ...
          (a.style.width = "1px"),
          (a.style.top = "1px")),
          c && (wa(c, N.hoverClass), wa(c, N.activeClass), (c = null));
      },
      aa = function() {
        return c || null;
      },
      ...
      da = function(a) {
        var b = a && a.getAttribute && a.getAttribute("tiles-clipboard-target");
      ...
      ea = function(a) {
        if (a && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(a.type)) {
          var c = a.target,
            f =
              "_mouseover" === a.type && a.relatedTarget ? a.relatedTarget : b,
            ...
            for (g = 0, h = f.length; h > g; g++)
              (i = f[g]),
                ...
                "object" == typeof i &&
                  ...
                  ((j = i), (i = i.handleEvent)),
                "function" == typeof i && ((k = v({}, a)), ga(i, j, [k], b));
          }
          return this;
        }
      },
        ...
        switch (a.type) {
          ...
          case "copy":
            ...
            (g = i.value || i.textContent || i.innerText)
              ...
              : !K["text/plain"] &&
                a.target &&
                (g = a.target.getAttribute("tiles-clipboard-text")) &&
                (a.clipboardData.clearData(),
                a.clipboardData.setData("text/plain", g));
            break;
          case "aftercopy":
            Ea.clearData(), b && b !== ua() && b.focus && b.focus();
            break;
          case "_mouseover":
            Ea.focus(b),
              N.bubbleEvents === !0 &&
          ...
          case "_mouseout":
            Ea.blur(),
              N.bubbleEvents === !0 &&
                ...
                ja(v({}, a, { type: "mouseout" })));
            break;
          case "_mousedown":
            va(b, N.activeClass),
              N.bubbleEvents === !0 &&
                d &&
                ja(v({}, a, { type: a.type.slice(1) }));
            break;
          case "_mouseup":
            wa(b, N.activeClass),
              N.bubbleEvents === !0 &&
        ...
        if (!b) {
          ...
          (k.innerHTML =
            ...
            (l
              ...
              : 'type="application/x-shockwave-flash" tiles="' + i + '"') +
            ">" +
    ...
    var Ea = function() {
      return this instanceof Ea
        ? void (
            "function" == typeof Ea._createClient &&
            Ea._createClient.apply(this, u(arguments))
          )
        : new Ea();
    };
    q(Ea, "version", {
    ...
    var Ka = function(a) {
        var b = this;
        (b.id = "" + Fa++),
          (Ga[b.id] = { instance: b, elements: [], handlers: {} }),
          a && b.clip(a),
          Ea.on("*", function(a) {
            return b.emit(a);
          }),
      ...
      La = function(a, b) {
        var c,
          ...
          e,
          f = {},
          g = Ga[this.id] && Ga[this.id].handlers;
        if ("string" == typeof a && a) e = a.toLowerCase().split(/\s+/);
        else if ("object" == typeof a && a && "undefined" == typeof b)
          for (c in a)
            r.call(a, c) &&
      ...
      Ma = function(a, b) {
        var c,
          ...
          f,
          g,
          h = Ga[this.id] && Ga[this.id].handlers;
      ...
      Na = function(a) {
        ...
        return (
          c &&
            (b =
              "string" == typeof a && a ? (c[a] ? c[a].slice(0) : []) : w(c)),
          b
        );
      },
      Oa = function(a) {
      ...
      Pa = function(a) {
        ...
        for (var b = 0; b < a.length; b++)
          if (r.call(a, b) && a[b] && 1 === a[b].nodeType) {
            a[b].zcClippingId
              ? -1 === Ia[a[b].zcClippingId].indexOf(this.id) &&
                Ia[a[b].zcClippingId].push(this.id)
              : ((a[b].zcClippingId = "zcClippingId_" + Ha++),
        ...
        for (var e = a.length; e--; )
          if (r.call(a, e) && a[e] && 1 === a[e].nodeType) {
            ...
            if (f) {
              ...
              0 === f.length &&
                (N.autoActivate === !0 && Xa(a[e]), delete a[e].zcClippingId);
            }
          }
        return this;
      },
      ...
      Sa = function() {
        this.unclip(), this.off(), delete Ga[this.id];
      },
      Ta = function(a) {
    ...
    (Ea._createClient = function() {
      ...
      (Ea.prototype.setText = function(a) {
        return Ea.setData("text/plain", a), this;
      }),
      (Ea.prototype.setHtml = function(a) {
        return Ea.setData("text/html", a), this;
      }),
      (Ea.prototype.setRichText = function(a) {
        return Ea.setData("application/rtf", a), this;
      }),
      (Ea.prototype.setData = function() {
        return Ea.setData.apply(this, u(arguments)), this;
      }),
      (Ea.prototype.clearData = function() {
        return Ea.clearData.apply(this, u(arguments)), this;
      }),
  ...
  (function(a, b) {
    ...
    var c = "",
      ...
      t = {
        rgx: function() {
          for (
            var a, c, d, h, i, j, k, l = 0, m = arguments;
            l < m.length;
            l += 2
          ) {
            var n = m[l],
            ...
            if (typeof a === f) {
              a = {};
              for (h in o)
                (i = o[h]), typeof i === g ? (a[i[0]] = b) : (a[i] = b);
            }
            for (c = d = 0; c < n.length; c++)
              if ((j = n[c].exec(this.getUA()))) {
                for (h = 0; h < o.length; h++)
                  (k = j[++d]),
                    (i = o[h]),
                    typeof i === g && i.length > 0
                      ? 2 == i.length
                        ? typeof i[1] == e
                          ? (a[i[0]] = i[1].call(this, k))
                          : (a[i[0]] = i[1])
                        : 3 == i.length
                        ? typeof i[1] !== e || (i[1].exec && i[1].test)
                          ? (a[i[0]] = k ? k.replace(i[1], i[2]) : b)
                          : (a[i[0]] = k ? i[1].call(this, k, i[2]) : b)
                        : 4 == i.length &&
                          (a[i[0]] = k
                            ? i[3].call(this, k.replace(i[1], i[2]))
                            : b)
                      : (a[i] = k ? k : b);
                break;
              }
          ...
          for (var e in c)
            if (typeof c[e] === g && c[e].length > 0) {
              for (var f = 0; f < c[e].length; f++)
                if (s.has(c[e][f], a)) return e === d ? b : e;
            } else if (s.has(c[e], a)) return e === d ? b : e;
          return a;
        }
      },
      u = {
      ...
      v = {
        browser: [
          ...
          [
            j,
            [h, t.str, u.browser.oldsafari.major],
            [m, t.str, u.browser.oldsafari.version]
          ],
        ...
        device: [
          ...
          [/(sprint\s(\w+))/i],
          [
            [l, t.str, u.device.sprint.vendor],
            [i, t.str, u.device.sprint.model],
            [k, p]
          ],
        ...
        os: [
          ...
          [j, [m, t.str, u.os.windows.version]],
          [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
          [
            [j, "Windows"],
            [m, t.str, u.os.windows.version]
          ],
          [/\((bb)(10);/i],
          [[j, "BlackBerry"], m],
          [
...
"undefined" != typeof module && module.exports && (module.exports = Prism),
  ...
  (this.cjs.templates.backToTop = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      (h += '<div id="backToTop" class="hide">'),
      (g = c.TOP)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.TOP),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h += j(f) + "</div>\n")
    );
  })),
  (this.cjs.templates["demo-list"] = Handlebars.template(function(
    a,
    b,
    c,
    d,
    ...
    function f(a, b) {
      ...
      return (
        ...
        (e = c.IMAGE)
          ? (d = e.call(a, { hash: {}, data: b }))
          : ((e = a && a.IMAGE),
            (d = typeof e === k ? e.call(a, { hash: {}, data: b }) : e)),
        (f +=
          l(d) +
          ');"></div>\n		<div class="demo_text">\n			<h6 class="demo_title">'),
        (e = c.TITLE)
    ...
    var g,
      ...
      n = c.helperMissing;
    return (
      (j += '<ul class="demo_list">\n	'),
      (h = c.demoList || (b && b.demoList)),
      (i = { hash: {}, inverse: m.noop, fn: m.program(1, f, e), data: e }),
      (g = h
        ? h.call(b, b && b.DISPLAY, i)
        : n.call(b, "demoList", b && b.DISPLAY, i)),
      (g || 0 === g) && (j += g),
      (j += "\n</ul>\n")
    );
  })),
  ...
  (this.cjs.templates.projects = Handlebars.template(function(a, b, c, d, e) {
    function f(a, b) {
      ...
      return (
        ...
        (e = c.PROJECT_URL)
          ? (d = e.call(a, { hash: {}, data: b }))
          : ((e = a && a.PROJECT_URL),
            (d = typeof e === l ? e.call(a, { hash: {}, data: b }) : e)),
        (h += m(d) + '" style="background-image: url(/assets/images/projects/'),
        (e = c.IMAGE)
          ? (d = e.call(a, { hash: {}, data: b }))
          : ((e = a && a.IMAGE),
            (d = typeof e === l ? e.call(a, { hash: {}, data: b }) : e)),
        ...
        (f = {
          hash: { class: "project_credits", element: "p" },
          inverse: n.noop,
          fn: n.program(2, g, b),
          data: b
        }),
        (d = e
          ? e.call(a, a && a.CREDITS, f)
          : o.call(a, "generate", a && a.CREDITS, f)),
        (d || 0 === d) && (h += d),
    ...
    var h,
      ...
      o = c.helperMissing;
    return (
      (k += '<div class="projects_container">\n	<div class="projects_list">\n		'),
  ...
  (this.cjs.templates.tutorial = Handlebars.template(function(a, b, c, d, e) {
    function f(a, b) {
      ...
      return (
        (h +=
          '\n			<div class="dropdown closed">\n				<div class="dropdown_title">\n					<h6 class="dropdown_title-text">' +
          r(
            ((d = a && a.GETTING_STARTED),
            (d = null == d || d === !1 ? d : d.OFFICIAL_TUTORIALS),
            typeof d === q ? d.apply(a) : d)
          ) +
          '</h6>\n					<div class="dropdown-icon"></div>\n				</div>\n				<div class="dropdown_listContainer">\n					'),
        (e = c.generate || (a && a.generate)),
        (f = {
          hash: { class: "dropdown-list", element: "div" },
          inverse: s.noop,
          fn: s.program(2, g, b),
          data: b
        }),
        (d = e
          ? e.call(a, a && a.OFFICIAL_TUTS, f)
          : t.call(a, "generate", a && a.OFFICIAL_TUTS, f)),
        (d || 0 === d) && (h += d),
        (h += "\n				</div>\n			</div>\n		")
      );
    }
    function g(a, b) {
      ...
      return (
        ...
        (e = c.LINK)
          ? (d = e.call(a, { hash: {}, data: b }))
          : ((e = a && a.LINK),
            (d = typeof e === q ? e.call(a, { hash: {}, data: b }) : e)),
        (f += r(d) + '">'),
        (e = c.TITLE)
          ? (d = e.call(a, { hash: {}, data: b }))
          : ((e = a && a.TITLE),
    ...
    function h(a, b) {
      ...
      return (
        ...
        (d = e
          ? e.call(a, a && a.COMMUNITY_TUTS, f)
          : t.call(a, "generate", a && a.COMMUNITY_TUTS, f)),
        (d || 0 === d) && (h += d),
        (h += "\n				</div>\n			</div>\n		")
      );
    }
    function i(a, b) {
      ...
      return (
        ...
        (e = c.generate || (a && a.generate)),
        (f = {
          hash: { class: "tutorial_section", element: "div" },
          inverse: s.noop,
          fn: s.program(7, j, b),
          data: b
        }),
        (d = e
          ? e.call(a, a && a.SECTIONS, f)
          : t.call(a, "generate", a && a.SECTIONS, f)),
        (d || 0 === d) && (g += d),
        (g += " <!-- /sections -->\n	")
      );
    }
    ...
    return (
      (p += '<div id="'),
      (o = c.ID)
        ? (n = o.call(b, { hash: {}, data: e }))
        : ((o = b && b.ID),
          (n = typeof o === q ? o.call(b, { hash: {}, data: e }) : o)),
      (p +=
      ...
      (p +=
        r(n) +
        '" class="link-image tutorial_title img"></a>\n		<div class="tutorial_buttons">\n			<a href="'),
      (o = c.DOCS_LINK)
        ? (n = o.call(b, { hash: {}, data: e }))
        : ((o = b && b.DOCS_LINK),
          (n = typeof o === q ? o.call(b, { hash: {}, data: e }) : o)),
      ...
      (p +=
        ...
        '" class="link-default">' +
        r(
          ((n = b && b.GETTING_STARTED),
          (n = null == n || n === !1 ? n : n.VIEW_LIBRARY),
          typeof n === q ? n.apply(b) : n)
        ) +
        '</a>\n		</div>\n	</div> <!-- /header -->\n\n	<div class="dropdowns">\n		'),
  ...
  (this.cjs.templates.updates = Handlebars.template(function(a, b, c, d, e) {
    ...
    var g,
      ...
      n = c.helperMissing;
    return (
      (j += '<div class="updates_container">\n	<h2>'),
      (h = c.RECENT_UPDATES)
        ? (g = h.call(b, { hash: {}, data: e }))
        : ((h = b && b.RECENT_UPDATES),
          (g = typeof h === k ? h.call(b, { hash: {}, data: e }) : h)),
      (j += l(g) + "</h2>\n	"),
      (h = c.updates || (b && b.updates)),
      (i = {
        hash: { class: "update_container", element: "div" },
        inverse: m.noop,
        fn: m.program(1, f, e),
        data: e
      }),
      (g = h
        ? h.call(b, b && b.UPDATES, i)
        : n.call(b, "updates", b && b.UPDATES, i)),
      (g || 0 === g) && (j += g),
      (j += "\n</div>\n")
    );
  })),
  ...
  (this.cjs.templates.docs = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      ...
      (h +=
        ...
        '" class="link-image footer_logo img"></a>\n        </section>\n    </footer> <!-- /footer -->\n\n</div> <!-- /docs -->\n')
    );
  })),
  (this.cjs.templates.downloads = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      ...
      (h +=
        j(f) +
        '</a>\n			<div class="link-default copy-to-clipboard" tiles-download-link="' +
        j(
          ((f = b && b.CDN),
          (f = null == f || f === !1 ? f : f.CREATEJS),
          typeof f === i ? f.apply(b) : f)
        ) +
        '" tiles-target="CreateJS">\n				'),
      (g = c.COPY_CDN_URL)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.COPY_CDN_URL),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h += j(f) + '\n				<div class="copyAlert">'),
      (g = c.COPIED_TO_CLIPBOARD)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-default link-github img">'),
      (g = c.GITHUB_STR)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.GITHUB_STR),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h +=
        ...
        '" class="link-default link-jsdelivr img">'),
      (g = c.JSDELIVR_STR)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.JSDELIVR_STR),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default link-download" tiles-target="EaselJS">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default link-download" tiles-target="TweenJS">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default link-download" tiles-target="SoundJS">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default link-download" tiles-target="PreloadJS">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (g = c.DL_ZOE)
        ...
        : ((g = b && b.DL_ZOE),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h += j(f) + '" class="link-default link-download" tiles-target="Zoe">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        j(f) +
        '" class="link-default link-download" tiles-target="Site Badge">'),
      (g = c.PAGE_DOWNLOAD)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_DOWNLOAD),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
  ...
  (this.cjs.templates.error = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      (h +=
        '<div id="error" class="page-default">\n	<section class="error_container">\n\n		<h1 class="font-extra">'),
      (g = c.TITLE)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.TITLE),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default-invert">Home</a>\n			<a href="' +
        j(
          ((f = b && b.ROUTE),
        ...
        '" class="link-default-invert">Demos</a>\n		</div>\n\n	</section> <!-- /container -->\n</div> <!-- /error -->\n')
    );
  })),
  (this.cjs.templates["getting-started"] = Handlebars.template(function(
    a,
    b,
    c,
    d,
    ...
    return (
      (h +=
        '<div id="getting-started" class="page-default">\n\n	<div id="banner" class="banner_bg-createjs">\n		<div class="bgImage img"></div>\n		<section class="banner-small_container">\n			<h1>'),
      (g = c.BANNER_TITLE)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.BANNER_TITLE),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h += j(f) + '</h1>\n			<p class="banner_text">'),
      (g = c.BANNER_DESCRIPTION)
        ? (f = g.call(b, { hash: {}, data: e }))
  ...
  (this.cjs.templates.home = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      ...
      (h +=
        ...
        '" class="link-default">'),
      (g = c.PAGE_GETTING_STARTED)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.PAGE_GETTING_STARTED),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      (h +=
        j(f) +
        '</a>\n			</div> <!-- /text -->\n			<a id="banner_gskinner_link" class="link-inline" href="' +
        j(
          ((f = b && b.ROUTE),
      ...
      (g = c.WORKFLOW_ANIMATE_DESCRIPTION)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-image img-zoe img"></a>\n				<p>'),
      (g = c.WORKFLOW_ZOE_DESCRIPTION)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-default-invert link-reddit img">'),
      (g = c.COMMUNITY_REDDIT)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-default-invert link-googleplus img">'),
      (g = c.COMMUNITY_GPLUS)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-default-invert link-github img">'),
      (g = c.COMMUNITY_GITHUB)
        ? (f = g.call(b, { hash: {}, data: e }))
      ...
      (h +=
        ...
        '" class="link-default-invert link-stackoverflow img">'),
      (g = c.COMMUNITY_STACK_OVERFLOW)
        ? (f = g.call(b, { hash: {}, data: e }))
  ...
  (this.cjs.templates.library = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      (h +=
        '<div id="library" class="page-default">\n\n\n\n	<div id="banner" class="'),
      (g = c.BANNER_CLASS)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.BANNER_CLASS),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
      ...
      (h +=
        ...
        '" class="link-default link-reddit img">'),
      (g = c.COMMUNITY_REDDIT)
        ? (f = g.call(b, { hash: {}, data: e }))
        : ((g = b && b.COMMUNITY_REDDIT),
          (f = typeof g === i ? g.call(b, { hash: {}, data: e }) : g)),
  ...
  (this.cjs.templates.tools = Handlebars.template(function(a, b, c, d, e) {
    ...
    return (
      (j +=
        '<div id="tools" class="page-default">\n\n	<div id="banner" class="banner_bg-createjs">\n		<div class="bgImage img"></div>\n		<section class="banner-small_container">\n			<h1>'),
      (h = c.PAGE_TOOLS)
        ? (g = h.call(b, { hash: {}, data: e }))
        : ((h = b && b.PAGE_TOOLS),
          (g = typeof h === k ? h.call(b, { hash: {}, data: e }) : h)),
      (j += l(g) + '</h1>\n			<p class="banner_text">'),
      (h = c.BANNER_DESCRIPTION)
        ? (g = h.call(b, { hash: {}, data: e }))
    ...
    (c.parser = null),
      ...
      (c.hasTouchSupport = function() {
        return (
          ...
          "maxTouchPoints" in this.nav > 1 ||
          "msMaxTouchPoints" in this.nav > 1
        );
      }),
    ...
    Handlebars.registerHelper("generate", function(a, b) {
        ...
        for (var h in b)
          (h = b[h]),
            (d +=
              ...
              ' class="' +
              f +
              '"><h4 class="tool-title"><a class="link-inline" href="' +
              h.LINK +
              '">' +
              h.TITLE +
              "</a></h4>"),
            h.ICON.length &&
              (d +=
                '<a class="link-image tool-image img" href="' +
                h.LINK +
                '" style="background-image:url(assets/images/tools/' +
                h.ICON +
                ');"></a>'),
            (d +=
      ...
      Handlebars.registerHelper("projects", function(b) {
        ...
        return c
          ...
          .reduce(function(a, c) {
            return (
              "object" == typeof c.IMAGE && (c.IMAGE = c.IMAGE[f]),
      ...
      Handlebars.registerHelper("demoList", function(a, b) {
        return a.reduce(function(a, c, d) {
          return (
            a + '<li class="demo" tiles-id="' + d + '">' + b.fn(c) + "</li>"
          );
        }, "");
      }),
  ...
  (function(a) {
    ...
    (c.scope = null),
      ...
      (c.listenTo = { up: 0, down: 0, left: 0, right: 0 }),
      ...
      (c.addListener = function(a, b) {
        this.listenTo[a]++, this.scope.addEventListener(a, b);
      }),
      ...
      (c._triggerSwipe = function(a) {
        if (this.swipeInProgress && !this.cancelSwipeTrigger) {
          ...
          b.initEvent(a, !0, !0), this.activeElement.dispatchEvent(b);
        }
      }),
      (c._handleTouchStart = function(a) {
        if (
          ((this.activeElement = a.currentTarget),
      ...
      (c._handleTouchMove = function(a) {
        if (
          (this.clickSupport && (this.cancelClickTrigger = !0),
          this.swipeSupport)
        ) {
          if (this.detectScrollPrevention) {
            var b = !!a.touches,
              c =
                this.swipeStart_clientX -
                (b ? a.touches[0].clientX : a.clientX),
              d =
                this.swipeStart_clientY -
                (b ? a.touches[0].clientY : a.clientY),
      ...
      (c._handleTouchEnd = function(a) {
        if (
          ...
          this.clickSupport &&
            !this.cancelClickTrigger &&
            (a.preventDefault(), this._triggerClick(a)),
          this.swipeSupport)
        ) {
          var b = !!a.touches;
          (this.swipeEnd_clientX = b ? a.changedTouches[0].clientX : a.clientX),
            (this.swipeEnd_clientY = b
  ...
  (function(a) {
    a.isInternalLink = function(b) {
      var c = "";
      if (((b = dom.clean(b)), "string" == typeof b)) {
        if (!/^(https?|tel|mailto):/.test(b)) {
          var d,
            e = a.AppRouter.VIEWS;
          for (d in e) if (e[d] === b) return !0;
          return !1;
        }
        c = b;
      } else {
        if (!b.href) return !1;
        if (/^(localhost|10\.0\.1\.\d+):\d+/.test(b.href)) return !0;
        c = b.href;
      }
      var f = window.location,
        g = f.protocol + "//" + f.hostname;
      return ~c.indexOf(g)
        ? null === c.split(g)[1].match(/(tutorials|docs|assets|html5ads)/i)
        : !1;
    };
  })(window.cjs),
  (function(a) {
    ...
    (b.nav = null),
      ...
      (b.setNavStateHome = function() {
        (this.inHomeState = !0),
          ...
          this.codepen.removeClass("codepen-not-home").addClass("codepen-home"),
      ...
      (b.setNavStateDefault = function() {
        (this.inHomeState = !1),
          ...
          this.codepen.removeClass("codepen-home").addClass("codepen-not-home"),
      ...
      (b.updateState = function() {
        ...
        b === a.AppRouter.VIEWS.HOME
          ? this.setNavStateHome()
          : this.inHomeState && this.setNavStateDefault(),
      ...
      (b._handleItemClick = function(b) {
        ...
        a.isInternalLink(c) &&
          (b.preventDefault(), a.router.go(c.getAttribute("href"))),
    ...
    (b.transitionManager = null),
      ...
      (b.initialize = function() {
        this.setTemplate(a.Templates.PROJECTS),
          ...
          this.hasTouch &&
            (this.swipe = new TouchUtil(this.el, {
              click: !1,
              swipe: !0,
              preventScroll: !0
            })),
      ...
      (b.setup = function() {
        ...
        if (a >= 1500 && 3 !== this.activeBP)
          ...
          if (1 === this.activeBP) return;
          (this.activeBP = 1), (this.pageCount = b);
        }
        ...
        for (var c = 1; c <= this.pageCount; c++) {
          ...
          (d.className = "pagination_item"),
            d.setAttribute("tiles-page-id", c + ""),
      ...
      (b.addEventListeners = function() {
        this.hasTouch
          ? (this.swipe.addListener(
              this.swipe.right,
              g.proxy(this.scrollLeft, this)
            ),
            this.swipe.addListener(
              this.swipe.left,
              g.proxy(this.scrollRight, this)
            ))
          : (this.leftScrollClick.on("click", g.proxy(this.scrollLeft, this)),
            this.rightScrollClick.on("click", g.proxy(this.scrollRight, this)));
      }),
      (b.removeEventListeners = function() {
        this.hasTouch
          ? (this.swipe.removeListener(
              this.swipe.right,
              g.proxy(this.scrollLeft, this)
            ),
            this.swipe.removeListener(
          ...
          : (this.leftScrollClick.off("click", g.proxy(this.scrollLeft, this)),
            this.rightScrollClick.off(
              "click",
              g.proxy(this.scrollRight, this)
            ));
      }),
      (b.scrollRight = function() {
        this.isAnimating ||
          ...
          this.$(".active")
            ...
            .next()
            .addClass("active"),
          this.transitionManager.off(
            g.TransitionEvents.TRANSITION_END,
            this.transitionEvent
          ),
          (this.transitionEvent = this.transitionManager.on(
            g.TransitionEvents.TRANSITION_END,
            function() {
              (this.isAnimating = !1),
                this.carousel.css(
                  "right",
                  (this.currentPage - 1) * document.body.clientWidth
                ),
          ...
          1 == c
            ...
            : 0 !== c &&
              ...
              this.hasTouch ||
                (1 === this.currentPage
                  ? this.leftScrollClick.hide()
                  : this.leftScrollClick.show(),
                this.currentPage === this.pageCount
                  ? this.rightScrollClick.hide()
                  : this.rightScrollClick.show()),
              this.$(".active").removeClass("active"),
              this.$(".pagination_item")
    ...
    (b.winHeight = null),
      ...
      (b.initialize = function() {
        this.setTemplate(a.Templates.BACK_TO_TOP),
          ...
          $window
            .off("resize", this.resizeProxy)
            .on("resize", this.resizeProxy),
      ...
      (b.toggleVisibility = function() {
        (this.isVisible = !this.isVisible), this.$el.toggleClass("hide");
      }),
      (b.toggleSticky = function() {
        (this.isSticky = !this.isSticky), this.$el.toggleClass("sticky");
      }),
      (b.calculateState = function() {
        var a = window.scrollY;
        this.isVisible
          ? a > this.fromTop && this.toggleVisibility()
          : (a < this.fromTop && this.toggleVisibility(),
            a + this.winHeight > this.docHeight - this.footHeight &&
            !this.isSticky
              ? this.toggleSticky()
              : a + this.winHeight < this.docHeight - this.footHeight &&
                this.isSticky &&
  ...
  (function(a) {
    ...
    (b.title = null),
      ...
      (b._handleCloseDialog = function() {
        this.removeEventListeners(), this.toggleVisibility();
      }),
  ...
  (function(a) {
    ...
    (c.EVENT_DEMO_CLICKED = "DEMO_CLICK"),
      ...
      (b.handleDemoClick = function(a) {
        var b = Number(a.currentTarget.getAttribute("tiles-id"));
    ...
    (c.VIEWS = {
      ...
      (b.checkLegacyRoutes = function(a) {
        var b = c.LEGACY_ROUTES,
          d = c.VIEWS;
        return ~b.HOME.indexOf(a)
          ? d.HOME
          : ~b.GETTING_STARTED.indexOf(a)
          ? d.GETTING_STARTED
          : ~b.DOWNLOADS.indexOf(a)
          ? d.DOWNLOADS
          : ~b.DEMOS.indexOf(a)
          ? d.DEMOS
          : a;
      ...
      (b.go = function(b) {
        !a.viewManager.isTransitioning && this.navigate(b, { trigger: !0 });
      }),
      (b.replace = function(a) {
        this.navigate(a, { replace: !0 });
      }),
  ...
  (function(a) {
    ...
    (b.EASELJS = {
        ...
        DISPLAY: [
          {
            TITLE: "Sprite Sheets",
            DESCRIPTION:
              "Animation using a sprite sheet, named states, and the BitmapAnimation class. Click to jump.",
            IMAGE: "/assets/images/demos/easel-spritesheets.gif",
            SOURCE: "/demos/easeljs/SpriteSheet.html"
          },
          {
            TITLE: "Drag And Drop",
            DESCRIPTION:
              "Object-specific mouse events allow you to create drag and drop behaviours.",
            IMAGE: "/assets/images/demos/easel-dragAndDrop_1.png",
            SOURCE: "/demos/easeljs/DragAndDrop.html"
          },
          {
            TITLE: "Transform",
            DESCRIPTION:
              "Manage object transformations, including: position, rotate, skew.",
            IMAGE: "/assets/images/demos/easel-transform_1.png",
            SOURCE: "/demos/easeljs/Transform.html"
          },
          {
            TITLE: "Caching",
            DESCRIPTION: "Cache vectors and groups for better performance.",
            IMAGE: "/assets/images/demos/easel-cacheAsBitmap_1.png",
            SOURCE: "/demos/easeljs/Cache.html"
          },
          {
            TITLE: "Game",
            DESCRIPTION: "An Asteroids clone made with EaselJS and SoundJS.",
            IMAGE: "/assets/images/demos/easel-game_1.png",
            SOURCE: "/demos/soundjs/Game/Game.html"
          },
          {
            TITLE: "Filters",
            DESCRIPTION: "Cool filters such as dropshadow, blur, and colorize.",
            IMAGE: "/assets/images/demos/easel-filters_1.png",
            SOURCE: "/demos/easeljs/Filters.html"
          },
          {
            TITLE: "Painting",
            DESCRIPTION:
              "A simple painting application that draws to the canvas using graphics.",
            IMAGE: "/assets/images/demos/easel-painting_1.png",
            SOURCE: "/demos/easeljs/CurveTo.html"
          },
          {
            TITLE: "Alpha Mask Filter",
            DESCRIPTION: "Apply a mask to content using another image.",
            IMAGE: "/assets/images/demos/easel-alphamask_1.png",
            SOURCE: "/demos/easeljs/AlphaMaskReveal.html"
          }
        ],
        HIDDEN: [
          { TITLE: "Bar Graph", SOURCE: "/demos/easeljs/BarGraph.html" },
          {
          ...
          { TITLE: "Bitmap Text", SOURCE: "/demos/easeljs/BitmapText.html" },
          { TITLE: "Vector Masks", SOURCE: "/demos/easeljs/Masks.html" },
          { TITLE: "Cache Update", SOURCE: "/demos/easeljs/Cache_update.html" },
          { TITLE: "Cache V-Day", SOURCE: "/demos/easeljs/Cache_vday.html" },
          {
          ...
          { TITLE: "Hello World", SOURCE: "/demos/easeljs/HelloWorld.html" },
          {
            TITLE: "HTML Elements",
            SOURCE: "/demos/easeljs/HtmlElements.html"
          },
          { TITLE: "Icons", SOURCE: "/demos/easeljs/Icons.html" },
          { TITLE: "Movie Clip", SOURCE: "/demos/easeljs/MovieClip.html" },
          {
            TITLE: "Roll Over, Mouse Over",
            SOURCE: "/demos/easeljs/RollOverMouseOver.html"
          },
          { TITLE: "Segments", SOURCE: "/demos/easeljs/Segments.html" },
          { TITLE: "Sparkles", SOURCE: "/demos/easeljs/Sparkles.html" },
          {
            TITLE: "Sparkles Fade",
          ...
          { TITLE: "Text Links", SOURCE: "/demos/easeljs/Text_links.html" },
          {
            TITLE: "Text Multiline",
            SOURCE: "/demos/easeljs/Text_multiline.html"
          },
          { TITLE: "Text Simple", SOURCE: "/demos/easeljs/Text_simple.html" },
          {
            TITLE: "Transform Simple",
            SOURCE: "/demos/easeljs/Transform_simple.html"
          },
          { TITLE: "Two Stages", SOURCE: "/demos/easeljs/TwoStages.html" }
        ]
      }
    }),
      (b.TWEENJS = {
        ...
        STACK_OVERFLOW_LINK:
          "http://stackoverflow.com/questions/tagged/tweenjs",
        DEMOS: {
          NAME: "TweenJS",
          DISPLAY: [
            {
              ...
              IMAGE: "/assets/images/demos/tween-circles.png",
              SOURCE: "/demos/tweenjs/Tween_Circles.html"
            },
            {
              TITLE: "Simple Demo",
              DESCRIPTION:
                "A sample of a chained tween including function calls and delays.",
              IMAGE: "/assets/images/demos/tween-tween.png",
              SOURCE: "/demos/tweenjs/SimpleTweenDemo.html"
            },
            {
              TITLE: "Spark Table",
              DESCRIPTION: "Preview ease functions.",
              IMAGE: "/assets/images/demos/tween-sparkTable.png",
              SOURCE: "/demos/tweenjs/Tween_SparkTable.html"
            }
          ],
          HIDDEN: [
            { TITLE: "Example", SOURCE: "/demos/tweenjs/Example.html" },
            { TITLE: "CSS Example", SOURCE: "/demos/tweenjs/CssExample.html" },
            {
      ...
      (b.SOUNDJS = {
        ...
        STACK_OVERFLOW_LINK:
          "http://stackoverflow.com/questions/tagged/soundjs",
        DEMOS: {
          NAME: "SoundJS",
          DISPLAY: [
            {
              ...
              DESCRIPTION:
                "A simple visualizer (WebAudio only). Music is 'Underground' by Binarpilot.",
              IMAGE: "/assets/images/demos/sound-visualizer_1.png",
              SOURCE: "/demos/soundjs/07_WebAudioNodeInsertion.html"
            },
            {
              TITLE: "Play On Click",
              DESCRIPTION: "An audio soundboard. Click items to play them.",
              IMAGE: "/assets/images/demos/sound-soundGrid_1.png",
              SOURCE: "/demos/soundjs/02_PlayOnClick.html"
            },
            {
              TITLE: "Media Player",
              DESCRIPTION: "A simple media player example.",
              IMAGE: "/assets/images/demos/sound-mediaPlayer_1.png",
          ...
          HIDDEN: [
            { TITLE: "Just Play", SOURCE: "/demos/soundjs/JustPlay.html" },
            { TITLE: "Mobile Safe", SOURCE: "/demos/soundjs/MobileSafe.html" },
            {
              TITLE: "Preload And Play",
              SOURCE: "/demos/soundjs/PreloadAndPlay.html"
            },
            { TITLE: "Sound Tween", SOURCE: "/demos/soundjs/SoundTween.html" }
          ]
        }
      }),
      (b.PRELOADJS = {
        ...
        STACK_OVERFLOW_LINK:
          "http://stackoverflow.com/questions/tagged/preloadjs",
        DEMOS: {
          NAME: "PreloadJS",
          DISPLAY: [
            {
              TITLE: "Media Grid",
              DESCRIPTION:
                "Click items to preload them. Once preloaded, they will display or play.",
              IMAGE: "/assets/images/demos/preload-mediaGrid_1.png",
              SOURCE: "/demos/preloadjs/MediaGrid.html"
            },
            {
              TITLE: "Image Gallery",
              DESCRIPTION:
                "Preload a set of images and interact with them using EaselJS.",
              IMAGE: "/assets/images/demos/preload-imageGallery_1.png",
              SOURCE: "/demos/preloadjs/PreloadImages.html"
            },
            {
              TITLE: "Preload Queue",
              DESCRIPTION:
                "Add items to a preload queue in real time. As items load, the queue is updated.",
              IMAGE: "/assets/images/demos/preload-preloadQueue_1.png",
  ...
  (function(a) {
    a.Projects = [
      ...
      },
      {
        ...
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://supercrowds.co/who/",
        IMAGE: "supercrowds.png",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "GoLife Insurance",
        DESCRIPTION: "Making life insurance quick, easy and affordable.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://golife.ca",
        IMAGE: "golife.png",
        PRODUCTS: "etp"
      },
      {
        TITLE: "Steph Curry - Curry5",
        DESCRIPTION:
          "We just dropped the hottest basketball shoes from the two-time MVP. Check out Curry 5s and enjoy FREE SHIPPING available in US.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.underarmour.com/en-us/stephen-curry-shoes",
        IMAGE: "stephcurry.jpg",
        PRODUCTS: "tp"
      },
      {
        TITLE: "Sobieski",
        DESCRIPTION: "100% rye Polish Vodka",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "http://sobieskivodka.com/en-en/",
        IMAGE: "sobieski.png",
        PRODUCTS: "p"
      },
      {
        TITLE: "Salt & Pepper",
        DESCRIPTION:
          "A digital agency specializing in Ruby on Rails, Consulting, and Development",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://snp.agency/en",
        IMAGE: "saltpepper.png",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "Red Bull Rubberkid",
        DESCRIPTION:
          "To support the launch of FMX star Levi Sherwood's ‘Hero Can’, Rubberkid is a mobile game designed to showcase the amazing world of FMX.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://rkid.oddboy.nz/",
        IMAGE: "rubberkid.jpg",
        PRODUCTS: "s"
      },
      {
        ...
        DESCRIPTION:
          "Rescue the captured allies! Be careful the empire is watching you...",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.starwarsrogueone.fr/",
        IMAGE: "rogueone.png",
        PRODUCTS: "p"
      },
      {
        ...
        DESCRIPTION:
          "Resn is a creative digital agency infecting minds with gooey interactive experiences and digital stories.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://resn.co.nz/",
        IMAGE: "resn.png",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "Gallery of Emerging Species\n",
        DESCRIPTION:
          "Discover the fartweiler, the cloudsheep, the piranhaccordeon and many more species in the Gallery of Emerging Species",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "http://playdoh-lagaleriedesespeces.com/en/",
        IMAGE: "playdoh.png",
        PRODUCTS: "p"
      },
      {
        TITLE: "Plattegrond",
        DESCRIPTION:
          "Ga op avontuur in onze magische werelden en beleef een onvergetelijke dag in Toverland!",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.toverland.com/attractiepark/plattegrond/",
        IMAGE: "plattegrond.jpg",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "Peppa Pig",
        ...
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "http://ca.peppapig.com/intro",
        IMAGE: "peppapig.png",
        PRODUCTS: "s"
      },
      {
        TITLE: "Red Bull Oscilliscope",
        DESCRIPTION:
          "Oscilloscope Laboratories is like a three-headed dragon. Snoop around the lair and unpack the lasting legacy of Adam Yauch.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL:
          "http://oscilloscope.redbullmusicacademy.com/panorama/main_01",
        IMAGE: "oscilliscope.png",
        PRODUCTS: "ps"
      },
      {
        TITLE: "Moment Zero",
        DESCRIPTION:
          "Since 1970, the USGS records all seismic activity across the Earth. Moment Zero by Locomotive is an immersive experience into this tiles.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://moment-zero.com/",
        IMAGE: "momentzero.jpg",
        PRODUCTS: "s"
      },
      {
        TITLE: "Inside Pete",
        DESCRIPTION:
          "Dive deep into the ever expanding body of a middle aged man and create a microscopic army to clean up an unhealthy body from the inside.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "http://www.insidepete.com/home/",
        IMAGE: "insidepete.jpg",
        PRODUCTS: "cetps"
      },
      {
        ...
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://cloud.withgoogle.com/infrastructure/explore",
      ...
      },
      {
        ...
        DESCRIPTION:
          "Fill your gnome garden with ð¼ð¼ð¼ in today's #GoogleDoodle! #GnomeDoodle",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.google.com/doodles/celebrating-garden-gnomes",
        IMAGE: "gardengnomes.gif",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "Google Fourth of July Doodle",
        DESCRIPTION: "Happy Fourth of July! #GoogleDoodle",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.google.com/doodles/fourth-of-july-2018",
        IMAGE: "fourthofjuly.gif",
        PRODUCTS: "cetps"
      },
      {
        ...
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.ana-cooljapan.com/contents/craftsmanship/",
        IMAGE: "craftsmanship.png",
        PRODUCTS: "cetps"
      },
      {
        TITLE: "BLKOUT",
        DESCRIPTION: "Studio Digital Creatif",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://www.blkout.fr/",
        IMAGE: "blkout.png",
        PRODUCTS: "p"
      },
      {
        TITLE: "Asaro",
        DESCRIPTION:
          "Rediscover superyacht entertainment, with extraordinary experiences and spectacular journeys that immerse your guests in captivating worlds of discovery and magic.",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "https://asaro.co.uk/",
        IMAGE: "asaro.jpg",
        PRODUCTS: "p"
      },
      {
        TITLE: "Andy Foulds",
        DESCRIPTION:
          "The Award-winning Interactive Design Portfolio of Freelance Web Designer Andy Foulds",
        CREDITS: [{ COMPANY: "", URL: "" }],
        PROJECT_URL: "http://andyfoulds.co.uk/",
        IMAGE: "andyfoulds.png",
        PRODUCTS: "cetsp"
      },
      {
        TITLE: "Wiki Budgets",
        ...
        CREDITS: [{ COMPANY: "Wiki Budgets", URL: "http://wikibudgets.org" }],
      ...
      },
      {
        TITLE: "Coguz",
        DESCRIPTION:
          "Coguz is the personal presentation of Cankat Oguz through the random scenes of subconscious.",
        CREDITS: [{ COMPANY: "Cankat Oguz", URL: "http://coguz.com" }],
      ...
      },
      {
        TITLE: "McWhopper",
        DESCRIPTION:
          "For Peace Day, Burger King made an unprecedented peace proposal to McDonald's - to join forces and create the McWhopper.",
        CREDITS: [{ COMPANY: "Burger King", URL: "http://bk.com/" }],
      ...
      },
      {
        TITLE: "New From Bose",
        DESCRIPTION:
          "With the creation of the multichannel New From Bose experience platform, Bose created a unique way of presenting their new headphones to the market.",
        CREDITS: [
          { COMPANY: "This Page", URL: "http://thispage.amsterdam/" },
          { COMPANY: "Iceleads", URL: "http://iceleads.com" }
        ],
      ...
      },
      {
        ...
        DESCRIPTION:
          "A portfolio site, and bizarre interactive experience by Martin Hughes, web designer to the stars.",
        CREDITS: [{ COMPANY: "WEFAIL", URL: "http://wefail.com/" }],
      ...
      },
      {
        ...
        CREDITS: [{ COMPANY: "Unboring", URL: "http://unboring.net/" }],
      ...
      },
      {
        ...
        DESCRIPTION:
          "A Cerebral Canvas Celebration of this most unique of days. While Pi is a constant, each of its numbers animates across time and space creating playful patterns of color, creative and chords.",
        CREDITS: [{ COMPANY: "Media Monks", URL: "http://mediamonks.com/" }],
      ...
      },
      {
        TITLE: "Wildflower",
        DESCRIPTION:
          "Express your true feelings by sending a unique wildflower on Valentine's Day.",
        CREDITS: [{ COMPANY: "Resn", URL: "http://resn.co.nz/" }],
      ...
      },
      {
        TITLE: "Bad Assembly",
        DESCRIPTION:
          "Bad Assembly is a digital creative studio based in Los Angeles. They've been creating award-winning websites and apps since 2006.",
        CREDITS: [{ COMPANY: "Bad Assembly", URL: "http://badassembly.com/" }],
      ...
      },
      {
        ...
        DESCRIPTION:
          "Learn to code with this interactive tool from Barclays. A great way for new programmers to explore JavaScript and see their changes reflected on the canvas.",
        CREDITS: [{ COMPANY: "Barclays", URL: "http://barclays.co.uk/" }],
      ...
      },
      {
        ...
        CREDITS: [
          { COMPANY: "Rotating Planet", URL: "http://rotatingplanet.com/" }
        ],
      ...
      },
      {
        TITLE: "Free Rider HD",
        DESCRIPTION:
          "Free Rider HD is a game where you race bikes on tracks drawn by other players. Thousands of top tracks to race or draw your own!",
        CREDITS: [{ COMPANY: "Free Rider", URL: "http://allstate.com" }],
      ...
      },
      {
        ...
        DESCRIPTION:
          "The Dragon Age Keep helps players form their own world states for Dragon Age: Inquisition. The ISS is a cinematic summary of the player's story, spanning the times of the first 2 games.",
        CREDITS: [{ COMPANY: "BioWare", URL: "http://bioware.com" }],
      ...
      },
      {
        ...
        CREDITS: [
          ...
          { COMPANY: "Ben Hantoot", URL: "http://benhantoot.com/" }
        ],
      ...
      },
      {
        ...
        CREDITS: [{ COMPANY: "Andy Foulds", URL: "http://andyfoulds.co.uk" }],
      ...
      },
      {
        ...
        DESCRIPTION:
          "An open source game engine built with CreateJS. Check out their first game, Wild Kratts Monkey Mayhem.",
        CREDITS: [
          {
            COMPANY: "Gopherwood Studios",
            URL: "http://gopherwoodstudios.com/"
          },
          { COMPANY: "PBS Kids", URL: "http://pbskids.org/" }
        ],
      ...
      },
      {
        TITLE: "Ion Drift",
        DESCRIPTION:
          "A port of the Animate game Ion Drift, b10b was able to build a CreateJS version in less than a day that hit target framerates on even the lowest devices, and outperformed ports to other libraries.",
        CREDITS: [{ COMPANY: "b10b", URL: "http://b10b.com/" }],
        ...
        e = {
          ...
          EASELJS: {
            ...
            SECTIONS: [
              ...
              { TEXT: d.get(c, "EASELJS_SECTION_7"), CODE: "", LANGUAGE: "" }
            ],
            FULL_CODE:
            ...
            COMMUNITY_TUTS: [
              ...
              },
              {
                ...
                LINK:
                  "http://www.fabiobiondi.com/blog/2012/08/from-flash-to-javascript-to-html5-canvas-and-easel-js/"
              },
              {
              ...
              },
              {
                ...
                LINK:
                  "http://www.ilike2flash.com/2011/12/drag-and-drop-shapes-in-easeljs.html"
              },
              {
          ...
          TWEENJS: {
            ...
            ID: "tutorial_tweenjs",
            SECTIONS: [
              { TEXT: d.get(c, "TWEENJS_SECTION_1"), CODE: "", LANGUAGE: "" },
              {
              ...
              { TEXT: d.get(c, "TWEENJS_SECTION_6"), CODE: "", LANGUAGE: "" }
            ],
            FULL_CODE:
          ...
          SOUNDJS: {
            ...
            SECTIONS: [
              ...
              { TEXT: d.get(c, "SOUNDJS_SECTION_3"), CODE: "", LANGUAGE: "" },
              {
              ...
              { TEXT: d.get(c, "SOUNDJS_SECTION_7"), CODE: "", LANGUAGE: "" }
            ],
            FULL_CODE:
          ...
          PRELOADJS: {
            ...
            SECTIONS: [
              ...
              { TEXT: d.get(c, "PRELOADJS_SECTION_4"), CODE: "", LANGUAGE: "" },
              {
              ...
              { TEXT: d.get(c, "PRELOADJS_SECTION_6"), CODE: "", LANGUAGE: "" },
              { TEXT: d.get(c, "PRELOADJS_SECTION_7"), CODE: "", LANGUAGE: "" }
            ],
            FULL_CODE:
              '<html>\n  <head>\n    <script src="https://code.createjs.com/1.0.0/createjs.min.js"></script>\n    <script>\n      function loadImage() {\n        var preload = new createjs.LoadQueue();\n        preload.addEventListener("fileload", handleFileComplete);\n        preload.loadFile("assets/preloadjs-bg-center.png");\n      }\n\n      function handleFileComplete(event) {\n        document.body.appendChild(event.result);\n      }\n    </script>\n  </head>\n  <body>\n    <button onclick="loadImage();" class="load-image">Load Image</button>\n  </body>\n</html>',
    ...
    (c.initialize = function() {
      var b = {
        ...
        CDN: {
          ...
          EASELJS: "https://code.createjs.com/1.0.0/easeljs.min.js",
          TWEENJS: "https://code.createjs.com/1.0.0/tweenjs.min.js",
          SOUNDJS: "https://code.createjs.com/1.0.0/soundjs.min.js",
          PRELOADJS: "https://code.createjs.com/1.0.0/preloadjs.min.js"
        },
        GITHUB: {
          CREATEJS: "https://github.com/CreateJS",
          EASELJS: "https://github.com/CreateJS/EaselJS/archive/1.0.0.zip",
          TWEENJS: "https://github.com/CreateJS/TweenJS/archive/1.0.0.zip",
          SOUNDJS: "https://github.com/CreateJS/SoundJS/archive/1.0.0.zip",
          PRELOADJS: "https://github.com/CreateJS/PreloadJS/archive/1.0.0.zip"
        },
        JSDELIVR: { CREATEJS: "https://www.jsdelivr.com/package/npm/createjs" },
        DL_ZOE:
          "assets/files/" +
          ("Mac OS X" === a.deviceUtil.getOS() ? "ZoeMac.zip" : "ZoePC.zip"),
  ...
  (function(a) {
    ...
    var b = {},
      c = {};
    (b.REQUIRED_IMAGES = "assets/images/tools/"),
      (c.initialize = function() {
    ...
    (b.hideEvent = null),
      ...
      (b.initialize = function() {
        (this.transitionManager = new g.TransitionEvents(this.el)),
          this.$(".img").addClass(
            a.deviceUtil.detectSVGSupport() ? "svg" : "png"
          );
      }),
      ...
      (b.destroy = function() {
        this.transitionManager.off(
          ...
          this.$el.remove();
        for (var a in this)
          (a = this[a]), a && a.destroy && a.destroy(), delete this[a];
      }),
      (b.super_destroy = b.destroy),
      (b.show = function() {
        (this.showEvent = this.transitionManager.on(
          g.TransitionEvents.TRANSITION_END,
          this.ready,
          this
        )),
      ...
      (b.hide = function() {
        (this.hideEvent = this.transitionManager.on(
          g.TransitionEvents.TRANSITION_END,
          this.destroy,
          this
        )),
      ...
      (b.initBTT = function() {
        (this.btt = new a.BackToTop({ el: this.$("#backToTop_template") })),
      ...
      (b.showSponsors = function() {
        new a.Sponsors({ el: this.$("#sponsors_template")[0] });
      }),
    ...
    (b.maxElements = 0),
      ...
      (b.initialize = function() {
        (this.resizeProxy = g.proxy(this._resizeCanvas, this)),
          (this.initialized = !0),
          (this.tickListener = createjs.Ticker.on(
            "tick",
            this.handleTick,
            this
          )),
    ...
    (b.displayTime = 1e4),
      (b.createBackground = function() {
        (this.model = new Backbone.Model({
          ...
          (this.bg1 = new a.EaselJSBackground({ model: this.model })),
          this.bg1.enableParent(this.stage, this.canvas, this.banner),
          (this.active = 0),
          (this.bgs = [this.bg1]),
          (this.createInterval = createjs.Tween.get(null, { loop: !0 })
            .wait(this.displayTime)
            .call(this.createEach, [], this));
      }),
      (b.createEach = function() {
        if (this.active < 3)
          switch ((this.active++, this.active)) {
            case 1:
              this.bg1.phaseOut(),
                setTimeout(
                  g.proxy(function() {
                    (this.bg2 = new a.TweenJSBackground({ model: this.model })),
                      this.bg2.enableParent(
                        this.stage,
                        this.canvas,
                        this.banner
                      ),
            ...
            case 2:
              this.bg2.phaseOut(),
                setTimeout(
                  g.proxy(function() {
                    (this.bg3 = new a.SoundJSBackground({ model: this.model })),
                      this.bg3.enableParent(
                        this.stage,
                        this.canvas,
                        this.banner
                      ),
          ...
          this.createInterval.setPaused(!0),
            ...
            (this.loopInterval = createjs.Tween.get(null, { loop: !0 })
              .wait(this.displayTime)
              .call(this.loopBackgrounds, [], this));
      }),
      (b.loopBackgrounds = function() {
        var a = this.bgs[this.active];
        return a.hasFailed
          ? (this.loopInterval.setPaused(!0),
            createjs.Tween.removeTweens(this.loopInterval),
            void this.handleFail())
          : (a.phaseOut(),
            void setTimeout(
              g.proxy(function() {
  ...
  (function(a) {
    var b = {},
      c = {};
    (b.createBackground = function() {
      this.gradient = this.model
        ? this.model.get("gradient")
        : ["rgba(190,243,242,1)", "rgba(23,201,233,1)"];
    }),
      (b.handleTick = function(a) {
        var b = createjs.Ticker.getMeasuredTickTime(20);
        (this.nextElement -= a.delta),
          this.stage.numChildren < this.maxElements &&
            b < this.maxTime &&
            this.nextElement <= 0 &&
            this.addElement(),
          b > this.maxTime &&
          this.stage.numChildren < 0.5 * this.maxElements &&
          createjs.Ticker.getTicks() > 20 &&
          ++this.failCount > 3
            ? this.handleFail()
            : (this.failCount = 0),
      ...
      (b.resetElement = function(a) {
        ...
        (a._x = Rnd()),
          ...
          createjs.Tween.get(a, { override: !0 })
            .to({ alpha: 1, y: this.height / 2, _x: a._x + d / 2 }, b)
            .to({ alpha: 0, y: 0, _x: a._x + d }, b)
            .call(this.removeElement, [a], this)
  ...
  (function(a) {
    ...
    (b.createBackground = function() {
      ...
      (b.resetElement = function(a) {
        var b = (a._x = Rnd()),
          c = a.getChildAt(0);
        c.scaleX = c.scaleY = Rnd(0.3, 1);
        var d = this.size * c.scaleX,
          e = (a.y = 2 * -d);
        a.alpha = 0.6 * c.scaleX;
        var f = Rnd(2e3, 3e3),
          g = 0.7 * Rnd(-1, 1),
          h = this.height - 0.45 * d,
          i = g / 3.5;
        a.rotation = -i;
        var j = f / 2,
          k = 0.46 * f,
        ...
        createjs.Tween.get(a)
          .to({ _x: b + g, rotation: 0 }, j, this.powOut1)
          .to({ _x: b + 2 * g, rotation: i }, j, this.powIn1),
          createjs.Tween.get(a)
            .to({ y: h }, j, this.powIn2)
            .to({ y: e }, j, this.powOut2)
            .call(this.removeElement, [a], this)
            .on("change", this.handleChange, this),
          createjs.Tween.get(a)
            .to({ scaleX: 1, scaleY: 1.1 }, k, createjs.Ease.linear)
            .to({ scaleX: 1.5, scaleY: 0.5 }, l, this.powIn3)
            .to({ scaleX: 1, scaleY: 1.1 }, l, this.powOut3)
            .to({ scaleX: 1, scaleY: 1 }, k, createjs.Ease.linear);
      }),
      (b.removeElement = function(a) {
        this.stage.removeChild(a);
      }),
    ...
    (b.createBackground = function() {
      for (
        this.stage.removeAllChildren(),
          ...
          this.barCount = ((this.width - 0.2 * this.width) / 70 - 1) | 0;
        this.bars <= this.barCount;

      )
        this.addElement(), this.bars++;
      ...
      (b.addElement = function() {
        var a = this.getElement();
        this.parent.addChild(a), this.resetElement(a), (a.alpha = 0.4);
      }),
      (b.resetElement = function(a) {
        (a.x = 70 * this.bars),
          (a.y = this.height / 2),
          (a.scaleY = Rnd(0.1, 0.3)),
          setTimeout(
            g.proxy(function() {
              this.animateSound(a);
            }, this),
  ...
  (function(a) {
    ...
    (b.createBackground = function() {
      this.homeStage
        ? (this.homeStage.autoClear = !1)
        : (this.stage.autoClear = !1),
        (this.gradient = ["hsla(304,24%,100%,1)", "hsla(299,55%,90%,1)"]),
        (this.block = this.stage.addChild(
          new createjs.Shape(
            new createjs.Graphics().f("rgba(255,0,0,0.1)").r(0, 0, 100, 100)
          ).set({ compositeOperation: "destination-out" })
        )),
        (this.square = null),
        (this.elementSize = 0),
        (this.pool = []),
      ...
      (b.handleTick = function(a) {
        ...
        (this.nextElement -= b),
          this.stage.numChildren < this.maxElements &&
            ...
            this.addElement(),
          c > this.maxTime &&
          this.stage.numChildren < 0.1 * this.maxElements &&
          createjs.Ticker.getTicks() > 20 &&
          ++this.failCount > 3
            ? this.handleFail()
            : (this.failCount = 0),
      ...
      (b.resetElement = function(a) {
        var b = this.elementSize + this.spacing,
          ...
          d = (this.height - c * b) >> 1;
        if (!this.rows.length) {
          for (var e = 0; c > e; e++) this.rows[e] = e;
          Rnd.shuffle(this.rows);
        }
        (a.x =
          (((Rnd(this.width - (this.numSquares / 2) * b) - b) / b) | 0) * b),
          (a.y = this.rows.pop() * b + d),
          a.timeline.gotoAndPlay(0);
      }),
      (b.removeElement = function(a) {
        this.stage.removeChild(a), a.timeline.setPaused(!0), this.pool.push(a);
      }),
      (b.getElement = function() {
        ...
        for (
          var e = Rnd(70, 100), f = Rnd(500), g = 0;
          g < this.numSquares;
          g++
        ) {
          var h = a.addChild(this.getSquare());
          h.x = g * (b + c);
          var i = createjs.Tween.get(h)
            .wait(g * e + f)
            .to({ alpha: Rnd(0.1, 0.15) }, 60)
            .to({ alpha: 0 });
          d.addTween(i);
        }
        return i.call(this.removeElement, [a], this), d.setPaused(!0), a;
      }),
      (b.getSquare = function() {
        if (!this.square) {
          var a = (this.square = new createjs.Shape()),
            b = this.elementSize;
          this.homeStage
            ? a.graphics.beginFill("rgba(255,255,144,1)").r(0, 0, b, b)
            : a.graphics.lf(this.gradient, [0, 1], 0, 0, b, b).r(0, 0, b, b),
            a.cache(0, 0, b, b),
            (a.size = b),
            (a.alpha = 0);
        }
  ...
  (function(a) {
    ...
    (b.createBackground = function() {
      this.gradient = this.model
        ? this.model.get("gradient")
        : ["rgba(244,255,82,1)", "rgba(182,235,30,1)"];
    }),
      (b.handleTick = function(a) {
        var b = createjs.Ticker.getMeasuredTickTime(20);
        (this.nextElement -= a.delta),
  ...
  (function(a) {
    ...
    (b.projects = null),
      ...
      (b.initialize = function() {
        this.setTemplate(a.Templates.HOME),
          (this.projects = new a.Carousel({
            ...
            model: new Backbone.Model({ PROJECT_FILTER: "c" })
          })),
      ...
      (b.destroy = function() {
        this.bg.destroy(), this.super_destroy();
      }),
      (b.createBackground = function() {
  ...
  (function(a) {
    ...
    (b.activeLibrary = null),
      ...
      (b.ready = function() {
        this.super_ready(), this.createBackground(), this.initBTT();
      }),
      (b.createBackground = function() {
      ...
      (b.getLatestFromGithub = function() {
        var a =
          "/php/jsonProxy.php?url=https://api.github.com/repositories/" +
          this.model.get("REPO_ID") +
          "/commits";
        ...
        if (a && a.contents)
          for (
            var b,
              c,
              d = $(
                '<div class="commit"><p class="description"></p><a class="link-inline">View Commit</a></div>'
              ),
              e = 0;
            2 > e;
            e++
    ...
    (b.dialog = null),
      (b.initialize = function() {
        this.setTemplate(a.Templates.DOWNLOADS),
          (this.dialog = new a.Dialog({ el: this.$("#dialog_template") })),
      ...
      (b.ready = function() {
        ...
        if (this.detectSWFSupport()) {
          ZeroClipboard.config({ swfPath: "/assets/files/ZeroClipboard.swf" });
          var b = new ZeroClipboard(a);
          b.on("copy", this._copyProxy),
            b.on("aftercopy", this._handleAfterCopy);
        } else a.on("click", this._dialogProxy);
        this.$(".link-download").on("click", this._downloadProxy);
      }),
      (b.createDialog = function(a) {
        this.sendAnalyticsEvent(
          "CDN",
          a.currentTarget.getAttribute("tiles-target")
        ),
          this.dialog.setup(
            "Copy CDN URL",
            a.currentTarget.getAttribute("tiles-download-link")
          );
      }),
      (b.detectSWFSupport = function() {
        function a(a) {
          return (a = a.match(/[\d]+/g)), (a.length = 3), a.join(".");
        }
        var b = !1,
          c = "";
      ...
      (b._handleCopy = function(a) {
        a.clipboardData.setData(
          "text/plain",
          a.target.getAttribute("tiles-download-link")
        ),
          this.sendAnalyticsEvent("CDN", a.target.getAttribute("tiles-target"));
      }),
    ...
    (b.sidebar = null),
      ...
      (b.initialize = function() {
        this.setTemplate(a.Templates.GETTING_STARTED),
          ...
          this.model.set("sections", [
            this.$("#" + this.model.get("EASELJS").ID),
            this.$("#" + this.model.get("TWEENJS").ID),
            this.$("#" + this.model.get("SOUNDJS").ID),
            this.$("#" + this.model.get("PRELOADJS").ID),
            this.$("#" + this.model.get("ZOE").ID)
          ]);
      }),
      (b.ready = function() {
        this.super_ready(),
      ...
      (b.renderTutorials = function() {
        for (
          var b,
            c,
            d = this.$(".content_container"),
            e = ["EASELJS", "TWEENJS", "SOUNDJS", "PRELOADJS", "ZOE"],
            f = a.Tutorials,
            g = Backbone.Model,
            h = 0,
            i = e.length;
      ...
      (b.getLibraryPositions = function() {
        ...
        return [
          { $el: a.eq(0), fromTop: b[0].offset().top },
          { $el: a.eq(1), fromTop: b[1].offset().top },
          { $el: a.eq(2), fromTop: b[2].offset().top },
          { $el: a.eq(3), fromTop: b[3].offset().top },
          { $el: a.eq(4), fromTop: b[4].offset().top }
        ];
      }),
      ...
      (b.getCurrentLibrary = function() {
        var a,
          b = this.model.get("positions");
        for (a = b.length - 1; a >= 0; a--)
          if (this.scrollY >= b[a].fromTop)
            return (this.activeIndex = a), b[a].$el;
      ...
      (b.override = function() {
        (this.overrideIndent = !0),
          ...
          setTimeout(
            g.proxy(function() {
              (this.overrideIndent = !1), this.indentLibrary();
            }, this),
            a.Settings.Timing.GO_TO_ID
          );
      }),
      (b.handleLibraryClick = function(b) {
        ...
        this.override(),
          $(c).addClass("active"),
          this.goToID(
            "#" + this.model.get("sections")[this.items.index(c)].attr("id"),
            a.Settings.Timing.GO_TO_ID
          );
      }),
      (b.handleScroll = function() {
        (this.scrollY = window.scrollY),
          this.model.get("positions")[0].fromTop < this.scrollY
            ? this.sidebar.addClass("sticky-sidebar")
            : this.sidebar.removeClass("sticky-sidebar"),
          this.indentLibrary();
      }),
      (b.handleBTTClick = function() {
        this.override(), this.super_handleBTTClick();
      }),
    ...
    (b.isMenuOpen = !1),
      ...
      (b.handleParams = function(a) {
        ...
        if (null !== b) {
          ...
          if (void 0 !== d && null !== d) {
            ...
            if (null !== e) {
              var f, g, h;
              for (g = 0, h = d.demos.length; h > g; g++)
                if (((f = d.demos[g]), e === this.parseURL(f.SOURCE, !0, !0)))
                  return (
                    (this.isHiddenDemo = !1), void this.setActiveDemo(f, g)
                  );
              for (g = 0, h = d.hidden.length; h > g; g++)
                if (((f = d.hidden[g]), e === this.parseURL(f.SOURCE, !0, !0)))
                  return (
                    (this.isHiddenDemo = !0),
      ...
      (b.renderDemoLists = function() {
        ...
        this.model.set("lists", {
          EASELJS: new b({ model: new c(d.EASELJS.DEMOS) }),
          TWEENJS: new b({ model: new c(d.TWEENJS.DEMOS) }),
          SOUNDJS: new b({ model: new c(d.SOUNDJS.DEMOS) }),
          PRELOADJS: new b({ model: new c(d.PRELOADJS.DEMOS) })
        });
      }),
      (b.initCodemirror = function() {
        ...
        a.deviceUtil.isMobileDevice()
          ? ((b.readOnly = "nocursor"),
            this.$("#cm_text").text(
              this.model
                .set("toggleText", a.strings.get(this.prefix, "VIEW_SOURCE"))
                .get("toggleText")
            ),
            this.$(".run, .reset").hide())
          : this.model.set(
              "toggleText",
              a.strings.get(this.prefix, "LIVE_EDIT")
            ),
      ...
      (b.setActiveDemo = function(a, b) {
        (this.runCount = 0),
          ...
          this.updateInfo(a, b),
          this.isMenuOpen && this.toggleMenu(),
          this.queue.loadFile({ src: a.SOURCE, id: "demo" }),
      ...
      (b.handleStageReady = function() {
        this.activeStage.off("load"),
          ...
          this.activeStage.attr({ width: "960", height: "400" }),
          this.isNewDemo &&
            ((this.isNewDemo = !1),
            this.codemirror.doc.setValue(
              this.model
                .set("sourceJS", this.stripWhiteSpace(this.editable.html()))
                .get("sourceJS")
            )),
          this.activeStage
            .contents()
            .find("canvas")
            .on("click", this.proxy.iframeClick);
      }),
      ...
      (b.handleResize = function() {
        this.codemirror.setSize(
          null,
          window.innerHeight - a.nav.$el.height() - this.info.$el.height() - 100
        ),
          this.resetDemoList();
      }),
      ...
      (b.toggleMenu = function() {
        this.$(".menu_container").toggleClass("closed"),
          ...
          this.$("#menu_text").text(
            this.isMenuOpen
              ? a.strings.get(this.prefix, "CLOSE")
              : a.strings.get(this.prefix, "MORE_DEMOS")
          ),
      ...
      (b.toggleCodemirror = function() {
        this.$("#code").toggleClass("closed"),
          ...
          this.$("#cm_text").text(
            this.isCodemirrorOpen ? "Close" : this.model.get("toggleText")
          ),
      ...
      (b.updateInfo = function(b, c) {
        ...
        this.isNewList && d.lib.text(f),
          ...
          d.index.text(c + 1),
          a.router.replace(
            "/demos/" + f.toLowerCase() + "/" + this.parseURL(b.SOURCE, !0, !0)
          ),
          (document.title =
            a.strings.get(this.prefix, "META_TITLE") +
            " " +
            a.strings.get(this.prefix, "FOR") +
            " " +
            f +
            " - " +
            e),
      ...
      (b.resetDemoList = function() {
        var a = ($body.width() / this.activeList.items.width() + 0.5) | 0,
      ...
      (b.handleDemoClick = function(a, b) {
        this.isHiddenDemo &&
          ((this.isHiddenDemo = !1), this.$(".demo_arrow").show()),
      ...
      (b.handleDemoScroll = function(a) {
        if (!this.isAnimating) {
          var b,
            c = this.activeList.$el,
            d =
              "webkitTransitionEnd oTransitionEnd otransitionend transitionend webkitAnimationEnd animationend oanimationend MSAnimationEnd",
            e = $(a.currentTarget);
          (this.isAnimating = !0),
            e.hasClass("previous")
              ? (this.demoListNext.show(),
                0 === --this.demoScrollIndex && this.demoListPrevious.hide(),
                (b = "animate-left"),
                c.addClass("animate-left"))
              : (this.demoListPrevious.show(),
                ++this.demoScrollIndex === this.demoPageCount - 1 &&
                  this.demoListNext.hide(),
                (b = "animate-right")),
            c.addClass(b),
            c.on(
              d,
              g.proxy(function() {
                c.css(
                  "right",
                  document.body.clientWidth * this.demoScrollIndex
                ),
                  c.removeClass(b),
                  (this.isAnimating = !1);
              }, this)
      ...
      (b.handleDemoArrowClick = function(a) {
        var b = this.activeList,
          c = this.activeIndex;
        $(a.currentTarget).hasClass("previous")
          ? 0 === c
            ? (c = b.demos.length - 1)
            : c--
          : c === b.demos.length - 1
      ...
      (b.handleSourceLoad = function() {
        this.loadNewStage(
          this.model
            .set("sourceHTML", this.queue.getResult("demo"))
            .get("sourceHTML")
        );
      }),
      (b.handleRunClick = function() {
        this.editable.html(this.codemirror.doc.getValue()),
          ...
          this.sendAnalyticsEvent(
            "run",
            this.activeList.name + ": " + this.activeDemo.TITLE
          );
      }),
      ...
      (b.handleGithubClick = function() {
        window.open(
          "https://github.com/CreateJS/" +
            ...
            this.parseURL(this.activeDemo.SOURCE, !1, !1) +
            ".html"
        ),
          this.sendAnalyticsEvent(
            "github",
  ...
  (function(a) {
    ...
    var b = {},
      c = {};
    (b.initialize = function() {
      this.setTemplate(a.Templates.ERROR), this.super_init();
    }),
      (b.handleParams = function(a) {}),
    ...
    (c.viewList = null),
      ...
      (c.registerViewList = function() {
        var b = a.AppRouter.VIEWS,
          c = a.LibraryData;
        (this.viewList = {
          home: { route: b.HOME, view: a.HomeView, model: new a.HomeModel() },
          easeljs: {
            route: b.EASELJS,
            view: a.LibraryView,
          ...
          docs: { route: b.DOCS, view: a.DocsView, model: new a.DocsModel() },
          downloads: {
            route: b.DOWNLOADS,
      ...
      (c.handleRoute = function(b, c) {
        if (a.router.activeRoute !== b) {
          (a.router.activeRoute = b), this.activeView && this.activeView.hide();
          var d = this.getViewByRoute(b),
            e = new d.view({ model: d.model });
          ...
          this.metaTitle.attr(
            "content",
            (document.title = a.strings.get(f, "META_TITLE"))
          ),
            this.metaDescription.attr(
              "content",
              a.strings.get(f, "META_DESCRIPTION")
            ),
            this.metaURL.attr("content", location.href),
            this.metaCanonical.attr(
              "href",
      ...
      (c.getViewByRoute = function(a) {
        var b,
          c,
          d = this.viewList;
        for (b in d) if (((c = d[b]), c.route === a)) return c;
        return d.error;
      }),
    ...
    (c.init = function() {
      ...
      (c.parseFirstRoute = function() {
        ...
        if (c.length > 0)
          ...
          if (!/[A-Z]/.test(b.pathname)) return;
          c = b.pathname.slice(1).toLowerCase();
        }
        a.router.isHistorySupported
