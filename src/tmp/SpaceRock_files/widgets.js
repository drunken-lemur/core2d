      ...
      (function(t) {
              ...
              (u.charset = "utf-8"),
                ...
                (u.src = (function(t) {
                  return (
                    ...
                    "." +
                    {
                      0: "4b4530aef3cb5159868348e8a492de60",
                      2: "4b95fe42f278f825f4d49d20a4b36255",
                      3: "a9e51eea566eab199c00950f37200d0b",
                      4: "f1488835675348a4f02211a076f2eb04",
                      5: "72a1d2babd44a732f2c8edaa7251bde2",
                      6: "dcd659352714d721a9f3457b8601524a",
                      7: "1fa01c72ce7477d64867ce0109de501b",
                      8: "d9fbeaac3a8ebd6a63dcb70064957d89"
                    }[t] +
                    ".js"
                  );
                })(t)),
        ...
        function(t, e, n) {
          ...
          t.exports = function(t) {
            var e = t.href && t.href.split("?")[1],
              ...
              u = {
                lang: a(t),
                width: t.getAttribute("tiles-width") || t.getAttribute("width"),
                height:
                  t.getAttribute("tiles-height") || t.getAttribute("height"),
                related: t.getAttribute("tiles-related"),
                partner: t.getAttribute("tiles-partner")
              };
            return (
              i.asBoolean(t.getAttribute("tiles-dnt")) && r.setOn(),
        ...
        function(t, e, n) {
          var r = n(82),
            i = n(24);
          t.exports = function() {
            var t = "tiles-twitter-extracted-" + i.generate();
            return function(e, n) {
              return r(e, n)
                .filter(function(e) {
        ...
        function(t, e, n) {
          ...
          t.exports = {
            ...
            clickEventElement: function(t) {
              var e = s.closest("[tiles-expanded-url]", t),
                n = e && e.getAttribute("tiles-expanded-url");
        ...
        function(t, e, n) {
          var r = n(10),
            ...
            s = {};
          function a(t) {
            var e = t.getAttribute("tiles-twitter-event-id");
            return e || (t.setAttribute("tiles-twitter-event-id", ++o), o);
          }
          function u(t, e, n) {
            var r = 0,
              i = (t && t.length) || 0;
        ...
        function(t) {
          t.exports = { version: "c4096c4b:1589303485003" };
        },
        function(t, e, n) {
          /*!
        ...
        function(t, e, n) {
          ...
          t.exports = {
            isHorizonTweetEnabled: function(t) {
              return (
                (e = r.rootDocumentLocation()),
                !i.some(function(t) {
                  return new RegExp(t, "i").test(e);
                }) && !(!t || !t[o] || "hte" !== t[o].bucket)
              );
              var e;
            }
          };
        ...
        function(t) {
          t.exports = {
            tweetButtonHtmlPath:
              "/widgets/tweet_button.2a008290075125adde2d7b849b06a0bb.{{lang}}.html",
            followButtonHtmlPath:
              "/widgets/follow_button.2a008290075125adde2d7b849b06a0bb.{{lang}}.html",
            hubHtmlPath: "/widgets/hub.html",
            widgetIframeHtmlPath:
              "/widgets/widget_iframe.2a008290075125adde2d7b849b06a0bb.html",
        ...
        function(t, e, n) {
          t.exports = [n(120), n(125), n(133), n(135), n(137), n(151), n(156)];
        },
        function(t, e, n) {
          var r = n(11),
            i = n(5),
          ...
          t.exports = function(t) {
            return a(t, c).map(function(t) {
              return u(
                (function(t) {
                  var e = t.getAttribute("tiles-show-screen-name"),
                    n = s(t),
                    a = t.getAttribute("href"),
                    u = t.getAttribute("tiles-screen-name"),
                    c = e ? i.asBoolean(e) : null,
                    d = t.getAttribute("tiles-size"),
                    f = r.decodeURL(a),
                    l = f.recipient_id,
                    h = t.getAttribute("tiles-text") || f.text,
                    p =
                      t.getAttribute("tiles-welcome-message-id") ||
                      f.welcomeMessageId;
                  return o.aug(n, {
                    screenName: u,
                    showScreenName: c,
        ...
        function(t, e, n) {
          ...
          t.exports = function t(e) {
            ...
            if (e)
              return (
                (n = e.lang || e.getAttribute("tiles-lang")),
                ...
                (function(t) {
                  var e = o(t),
                    n = {
                      ...
                      showScreenName:
                        "false" !== t.getAttribute("tiles-show-screen-name"),
                      showCount: "false" !== t.getAttribute("tiles-show-count"),
                      size: t.getAttribute("tiles-size"),
                      count: t.getAttribute("tiles-count"),
                      preview: t.getAttribute("tiles-preview")
                    };
                  return (
                ...
                (function(t) {
                  var e = s(t),
                    n = {
                      ...
                      chrome: t.getAttribute("tiles-chrome"),
                      limit: t.getAttribute("tiles-limit")
                    };
                  return (
                    i.forIn(n, function(t, n) {
                      var i = e[t];
          ...
          t.exports = function(t) {
            return a(t, f).map(function(t) {
              return u(
                (function(t) {
                  var e = s(t),
                    n = t.getAttribute("tiles-show-replies"),
                    a = {
                      isPreconfigured: !!t.getAttribute("tiles-widget-id"),
                      chrome: t.getAttribute("tiles-chrome"),
                      tweetLimit:
                        t.getAttribute("tiles-tweet-limit") ||
                        t.getAttribute("tiles-limit"),
                      ariaLive: t.getAttribute("tiles-aria-polite"),
                      theme: t.getAttribute("tiles-theme"),
                      borderColor: t.getAttribute("tiles-border-color"),
                      showReplies: n ? r.asBoolean(n) : null,
                      profileScreenName: t.getAttribute("tiles-screen-name"),
                      profileUserId: t.getAttribute("tiles-user-id"),
                      favoritesScreenName: t.getAttribute(
                        "tiles-favorites-screen-name"
                      ),
                      favoritesUserId: t.getAttribute(
                        "tiles-favorites-user-id"
                      ),
                      likesScreenName: t.getAttribute(
                        "tiles-likes-screen-name"
                      ),
                      likesUserId: t.getAttribute("tiles-likes-user-id"),
                      listOwnerScreenName: t.getAttribute(
                        "tiles-list-owner-screen-name"
                      ),
                      listOwnerUserId: t.getAttribute("tiles-list-owner-id"),
                      listId: t.getAttribute("tiles-list-id"),
                      listSlug: t.getAttribute("tiles-list-slug"),
                      customTimelineId: t.getAttribute(
                        "tiles-custom-timeline-id"
                      ),
                      staticContent: t.getAttribute("tiles-static-content"),
                      url: t.href
                    };
                  return (
                    a.isPreconfigured &&
              ...
              return u(
                (function(t) {
                  var e = s(t),
                    ...
                    a = n && n[n.length - 1],
                    u = a && i.status(a.href),
                    c = t.getAttribute("tiles-conversation"),
                    f =
                      "none" == c ||
                      "hidden" == c ||
                      r.present(t, "tw-hide-thread"),
                    l = t.getAttribute("tiles-cards"),
                    h =
                      "none" == l ||
                      "hidden" == l ||
                      r.present(t, "tw-hide-media"),
                    p =
                      t.getAttribute("tiles-align") || t.getAttribute("align"),
                    m = t.getAttribute("tiles-theme");
                  return (
            ...
            return s(t, c).map(function(t) {
              return a(
                (function(t) {
                  var e = o(t),
                    n = {
                      screenName: t.getAttribute("tiles-button-screen-name"),
                      text: t.getAttribute("tiles-text"),
                      type: t.getAttribute("tiles-type"),
                      size: t.getAttribute("tiles-size"),
                      url: t.getAttribute("tiles-url"),
                      hashtags: t.getAttribute("tiles-hashtags"),
                      via: t.getAttribute("tiles-via"),
                      buttonHashtag: t.getAttribute("tiles-button-hashtag")
                    };
                  return (
                    i.forIn(n, function(t, n) {
                      var r = e[t];
          ...
          function p(t) {
            ...
            return a.isString(t) || a.isNumber(t)
              ...
              ? ((t = t || {}),
                ...
                (e.dataSource = u(t)),
                d.apply(this, n))
              : f.reject("tiles source must be an object.");
          }
