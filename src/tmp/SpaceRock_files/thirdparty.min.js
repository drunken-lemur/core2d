...
(function() {
  ...
  var y = (x.each = x.forEach = function(a, b, d) {
    if (null != a)
      if (l && a.forEach === l) a.forEach(b, d);
        ...
        for (var g in a) if (x.has(a, g) && b.call(d, a[g], g, a) === c) return;
  });
  ...
  (x.reduce = x.foldl = x.inject = function(a, b, c, d) {
    ...
    (x.reduceRight = x.foldr = function(a, b, c, d) {
      ...
      if ((null == a && (a = []), o && a.reduceRight === o))
        return (
          d && (b = x.bind(b, d)), e ? a.reduceRight(b, c) : a.reduceRight(b)
        );
      var f = a.length;
      if (f !== +f) {
        var g = x.keys(a);
    ...
    (x.debounce = function(a, b, c) {
      ...
      return function() {
        var f = this,
          ...
          i = c && !d;
        return (
          clearTimeout(d), (d = setTimeout(h, b)), i && (e = a.apply(f, g)), e
        );
      };
    }),
    (x.once = function(a) {
  ...
  (x.isEqual = function(a, b) {
    ...
    y(["Arguments", "Function", "String", "Number", "Date", "RegExp"], function(
      a
    ) {
      x["is" + a] = function(b) {
  ...
  (x.template = function(a, b, c) {
    ...
    a.replace(e, function(b, c, d, e, h) {
      return (
        (g += a.slice(f, h).replace(K, function(a) {
          return "\\" + J[a];
        })),
  ...
  function() {
    ...
    h.each(m, function(a, b) {
      i[b] = function(b, c, d) {
        ...
        return (
          (e[f] = b), "object" == typeof c && (d = this), b[a](c, d, this), this
        );
      };
    }),
      (i.bind = i.on),
    ...
    h.extend(n.prototype, i, {
      ...
      save: function(a, b, c) {
        ...
        if (
          (null == a || "object" == typeof a
            ? ((d = a), (c = b))
            : ((d = {})[a] = b),
          d && (!c || !c.wait) && !this.set(d, c))
        )
          return !1;
        if (((c = h.extend({ validate: !0 }, c)), !this._validate(d, c)))
          return !1;
      ...
      url: function() {
        var a =
          h.result(this, "urlRoot") || h.result(this.collection, "url") || K();
        return this.isNew()
          ? a
          : a +
              ("/" === a.charAt(a.length - 1) ? "" : "/") +
    ...
    var q = (a.Collection = function(a, b) {
      ...
      r = { add: !0, remove: !0, merge: !0 },
      s = { add: !0, merge: !1, remove: !1 };
    h.extend(q.prototype, i, {
        ...
        for (c = 0, d = a.length; d > c; c++)
          (f = this.get(a[c])),
            f &&
              ...
              this.length--,
              b.silent || ((b.index = e), f.trigger("remove", f, this, b)),
      ...
      set: function(a, b) {
        ...
        var c,
          ...
          p = {};
        for (c = 0, d = a.length; d > c; c++)
          (f = this._prepareModel(a[c], b)) &&
            ((i = this.get(f))
              ? (b.remove && (p[i.cid] = !0),
                b.merge &&
                  (i.set(f.attributes, b),
                  l && !j && i.hasChanged(m) && (j = !0)))
              : b.add &&
                (n.push(f),
        ...
        if (
          (n.length &&
            ...
            null != k
              ? g.apply(this.models, [k, 0].concat(n))
              : e.apply(this.models, n)),
      ...
      unshift: function(a, b) {
        return (
          (a = this._prepareModel(a, b)), this.add(a, h.extend({ at: 0 }, b)), a
        );
      },
      shift: function(a) {
        var b = this.at(0);
        ...
        start: function(b) {
          ...
          return this._wantsHashChange &&
            ...
            : (this._wantsPushState &&
                ...
                g &&
                f.hash &&
                ((this.fragment = this.getHash().replace(F, "")),
      ...
      d = (function(a, b) {
        ...
        function d(a) {
          a.registerHelper("helperMissing", function(a) {
            ...
            a.registerHelper("with", function(a, b) {
              return (
                m(a) && (a = a.call(this)), g.isEmpty(a) ? void 0 : b.fn(a)
              );
            }),
        ...
        var p = {
          ...
          log: function(a, b) {
            if (p.level <= a) {
              var c = p.methodMap[a];
              "undefined" != typeof console && console[c];
            }
          }
        };
        (f.logger = p), (f.log = e);
    ...
    searchString: function(a) {
      for (var b = 0; b < a.length; b++) {
        var c = a[b].string,
          d = a[b].prop;
        if (
          ((this.versionSearchString = a[b].versionSearch || a[b].identity), c)
        ) {
