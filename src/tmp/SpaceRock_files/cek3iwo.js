 ...
 *
 * effra:
 *   - http://typekit.com/eulas/0000000000000000000142e5
 *   - http://typekit.com/eulas/0000000000000000000142e6
 *   - http://typekit.com/eulas/0000000000000000000142e9
 * proxima-nova:
...
window.Typekit.config = {
  ...
  fi: [139, 140, 175, 176, 9785, 9786, 9787],
  fc: [
    {
      id: 139,
      family: "proxima-nova",
      src:
        "https://use.typekit.net/af/bc719c/00000000000000000001499c/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        display: "auto",
    ...
    },
    {
      ...
      family: "proxima-nova",
      src:
        "https://use.typekit.net/af/c60268/0000000000000000000148a9/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "italic",
        display: "auto",
    ...
    },
    {
      ...
      family: "proxima-nova",
      src:
        "https://use.typekit.net/af/42fca5/0000000000000000000148a4/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "normal",
        display: "auto",
    ...
    },
    {
      ...
      family: "proxima-nova",
      src:
        "https://use.typekit.net/af/37c6ec/0000000000000000000148a5/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "italic",
        display: "auto",
    ...
    },
    {
      ...
      family: "effra",
      src:
        "https://use.typekit.net/af/bc8918/0000000000000000000142e5/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "normal",
        display: "auto",
    ...
    },
    {
      ...
      family: "effra",
      src:
        "https://use.typekit.net/af/d736c6/0000000000000000000142e6/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "italic",
        display: "auto",
    ...
    },
    {
      ...
      family: "effra",
      src:
        "https://use.typekit.net/af/a610a9/0000000000000000000142e9/23/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        display: "auto",
  ...
  fn: ["effra", ["i4", "n4", "n7"], "proxima-nova", ["i4", "i7", "n4", "n7"]],
  hn: "use.typekit.net",
  ht: "tk",
  js: "1.19.2",
  kt: "cek3iwo",
