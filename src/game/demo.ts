...
import { FpsLabel, Label, ScoreLabel, Square } from "lib/entity";
...
class IntroScene extends BaseScene {
  ...
  constructor(game: IGame) {
    ...
    this.add(
      ...
      new Label("Test1")
        .align(this, Position.CENTER_LEFT)
        .setStyle({ font, textAlign: "left", textBaseline: "middle" }),

      new FpsLabel()
        .align(this, Position.TOP_RIGHT)
        .setStyle({ font, textAlign: "right" }),

      new ScoreLabel().setStyle({ font, textAlign: "left" }),

      new Label("Test2")
        .align(this, Position.CENTER)
        .setStyle({ font, textAlign: "center", textBaseline: "middle" })
